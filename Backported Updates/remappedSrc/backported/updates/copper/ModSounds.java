...
public class ModSounds {
    public static Supplier<class_3414> COPPER_GOLEM_DEATH_UNAFFECTED;
    public static Supplier<class_3414> COPPER_GOLEM_HURT_UNAFFECTED;
    public static Supplier<class_3414> COPPER_GOLEM_STEP_UNAFFECTED;
    public static Supplier<class_3414> COPPER_GOLEM_HEAD_SPIN_UNAFFECTED;
    public static Supplier<class_3414> COPPER_GOLEM_DEATH_EXPOSED;
    public static Supplier<class_3414> COPPER_GOLEM_HURT_EXPOSED;
    public static Supplier<class_3414> COPPER_GOLEM_STEP_EXPOSED;
    public static Supplier<class_3414> COPPER_GOLEM_HEAD_SPIN_EXPOSED;
    public static Supplier<class_3414> COPPER_GOLEM_DEATH_WEATHERED;
    public static Supplier<class_3414> COPPER_GOLEM_HURT_WEATHERED;
    public static Supplier<class_3414> COPPER_GOLEM_STEP_WEATHERED;
    public static Supplier<class_3414> COPPER_GOLEM_HEAD_SPIN_WEATHERED;
    public static Supplier<class_3414> COPPER_GOLEM_DEATH_OXIDIZED;
    public static Supplier<class_3414> COPPER_GOLEM_HURT_OXIDIZED;
    public static Supplier<class_3414> COPPER_GOLEM_STEP_OXIDIZED;
    public static Supplier<class_3414> COPPER_GOLEM_HEAD_SPIN_OXIDIZED;
    public static Supplier<class_3414> COPPER_GOLEM_SPAWN;
    public static Supplier<class_3414> COPPER_GOLEM_BECOME_STATUE;
    public static Supplier<class_3414> COPPER_GOLEM_SHEAR;
    public static Supplier<class_3414> COPPER_GOLEM_ITEM_DROP;
    public static Supplier<class_3414> COPPER_GOLEM_ITEM_NO_DROP;
    public static Supplier<class_3414> COPPER_GOLEM_ITEM_GET;
    public static Supplier<class_3414> COPPER_GOLEM_ITEM_NO_GET;
    public static Supplier<class_3414> COPPER_CHEST_CLOSE;
    public static Supplier<class_3414> COPPER_CHEST_OPEN;
    public static Supplier<class_3414> COPPER_STATUE_BREAK;
    public static Supplier<class_3414> COPPER_STATUE_PLACE;
    public static Supplier<class_3414> COPPER_STATUE_HIT;
    public static Supplier<class_3414> COPPER_STATUE_BECOME;
    public static Supplier<class_3414> SHELF_ACTIVATE;
    public static Supplier<class_3414> SHELF_DEACTIVATE;
    public static Supplier<class_3414> SHELF_PLACE_ITEM;
    public static Supplier<class_3414> SHELF_TAKE_ITEM;
    public static Supplier<class_3414> SHELF_SINGLE_SWAP;
    public static Supplier<class_3414> SHELF_MULTI_SWAP;
    public static Supplier<class_3414> ARMOR_EQUIP_COPPER;
    public static Supplier<class_3414> WEATHER_END_FLASH;

    public static void register() {
        Constants.LOG.info("Registering sounds for {}", (Object)"Copper-Age-Backport");
    ...
    private static Supplier<class_3414> registerSound(RegistryHelper helper, String name) {
        class_2960 id = class_2960.method_60656((String)name);
        return helper.registerAuto(class_7924.field_41225, name, () -> class_3414.method_47908((class_2960)id));
    }
}
