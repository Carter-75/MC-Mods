...
implements class_5955 {
    public static final MapCodec<WeatheringCopperGolemStatueBlock> CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group((App)class_5955.class_5811.field_46493.fieldOf("weathering_state").forGetter(CopperGolemStatueBlock::getWeatheringState), (App)WeatheringCopperGolemStatueBlock.method_54096()).apply((Applicative)instance, WeatheringCopperGolemStatueBlock::new));

    public WeatheringCopperGolemStatueBlock(class_5955.class_5811 weatheringState, class_4970.class_2251 properties) {
        super(weatheringState, properties);
    }

    protected MapCodec<? extends WeatheringCopperGolemStatueBlock> method_53969() {
        return CODEC;
    }
    ...
    public static Optional<class_2248> getWaxedBlock(class_2248 block) {
        if (block == ModBlocks.COPPER_GOLEM_STATUE.get()) {
            return Optional.of((class_2248)ModBlocks.WAXED_COPPER_GOLEM_STATUE.get());
        }
        if (block == ModBlocks.EXPOSED_COPPER_GOLEM_STATUE.get()) {
            return Optional.of((class_2248)ModBlocks.WAXED_EXPOSED_COPPER_GOLEM_STATUE.get());
        }
        if (block == ModBlocks.WEATHERED_COPPER_GOLEM_STATUE.get()) {
            return Optional.of((class_2248)ModBlocks.WAXED_WEATHERED_COPPER_GOLEM_STATUE.get());
        }
        if (block == ModBlocks.OXIDIZED_COPPER_GOLEM_STATUE.get()) {
            return Optional.of((class_2248)ModBlocks.WAXED_OXIDIZED_COPPER_GOLEM_STATUE.get());
        }
        return Optional.empty();
    }
    ...
    protected class_9062 method_55765(class_1799 stack, class_2680 state, class_1937 level, class_2338 pos, class_1657 player, class_1268 hand, class_3965 hitResult) {
        ...
        if (stack.method_31573(class_3489.field_42612)) {
            Optional<class_2248> previousBlock = WeatheringCopperGolemStatueBlock.getPreviousBlock(state.method_26204());
            if (previousBlock.isPresent()) {
                ...
                if (!level.field_9236) {
                    class_2680 newState = (class_2680)((class_2680)((class_2680)previousBlock.get().method_9564().method_11657((class_2769)FACING, (Comparable)((class_2350)state.method_11654((class_2769)FACING)))).method_11657((class_2769)POSE, (Comparable)((Object)((CopperGolemStatueBlock.Pose)((Object)state.method_11654((class_2769)POSE)))))).method_11657((class_2769)WATERLOGGED, (Comparable)((Boolean)state.method_11654((class_2769)WATERLOGGED)));
