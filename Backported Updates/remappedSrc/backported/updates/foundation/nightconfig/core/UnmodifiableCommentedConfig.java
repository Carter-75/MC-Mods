...
extends UnmodifiableConfig {
    ...
    default public void getComments(Map<String, CommentNode> destination) {
        for (backported.updates.foundation.nightconfig.core.UnmodifiableCommentedConfig.Entry entry : this.entrySet()) {
    ...
    public Set<? extends backported.updates.foundation.nightconfig.core.UnmodifiableCommentedConfig.Entry> entrySet();
