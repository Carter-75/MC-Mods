...
implements PaleOakBoatBehavior {
    public PaleOakChestBoat(class_1299<? extends class_1690> entityType, class_1937 level) {
        super(entityType, level);
    }

    public PaleOakChestBoat(class_1937 level, double x, double y, double z) {
    ...
    protected void method_5623(double y, boolean onGround, class_2680 state, class_2338 pos) {
        this.fall((class_1690)this, y, onGround);
    }
