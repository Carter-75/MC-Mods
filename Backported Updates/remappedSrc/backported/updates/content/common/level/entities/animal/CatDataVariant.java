...
{
    public static final Codec<CatDataVariant> CODEC = RecordCodecBuilder.create(instance -> instance.group((App)ClientAsset.DEFAULT_FIELD_CODEC.forGetter(CatDataVariant::assetInfo), (App)SpawnPrioritySelectors.CODEC.fieldOf("spawn_conditions").forGetter(CatDataVariant::spawnConditions)).apply((Applicative)instance, CatDataVariant::new));
