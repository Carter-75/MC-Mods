...
{
    public static final class_9139<class_9129, ChickenVariant> STREAM_CODEC = class_9135.method_56365(ModRegistries.CHICKEN_VARIANT_KEY);
    public static final Codec<ChickenVariant> CODEC = RecordCodecBuilder.create(instance -> instance.group((App)ModelAndTexture.codec(ModelType.CODEC, ModelType.NORMAL).forGetter(ChickenVariant::modelAndTexture), (App)SpawnPrioritySelectors.CODEC.fieldOf("spawn_conditions").forGetter(ChickenVariant::spawnConditions)).apply((Applicative)instance, ChickenVariant::new));
