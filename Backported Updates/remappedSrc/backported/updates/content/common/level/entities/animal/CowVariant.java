...
{
    public static final class_9139<class_9129, CowVariant> STREAM_CODEC = class_9135.method_56365(ModRegistries.COW_VARIANT_KEY);
    public static final Codec<CowVariant> CODEC = RecordCodecBuilder.create(instance -> instance.group((App)ModelAndTexture.codec(ModelType.CODEC, ModelType.NORMAL).forGetter(CowVariant::modelAndTexture), (App)SpawnPrioritySelectors.CODEC.fieldOf("spawn_conditions").forGetter(CowVariant::spawnConditions)).apply((Applicative)instance, CowVariant::new));
