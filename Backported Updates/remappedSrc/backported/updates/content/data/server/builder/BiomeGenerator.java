...
extends FabricDynamicRegistryProvider {
    public BiomeGenerator(FabricDataOutput output, CompletableFuture<class_7225.class_7874> registriesFuture) {
    ...
    private void add(class_7225.class_7874 provider, FabricDynamicRegistryProvider.Entries entries, class_5321<class_1959> key) {
        class_7225.class_7226 registry = provider.method_46762(class_7924.field_41236);
        entries.add(key, (Object)((class_1959)registry.method_46747(key).comp_349()));
    }
