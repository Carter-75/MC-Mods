...
public class PaleMossPatchCeilingFeature
extends class_3031<PaleMossPatchCeilingConfig> {
    public PaleMossPatchCeilingFeature(Codec<PaleMossPatchCeilingConfig> configCodec) {
        super(configCodec);
    }

    public boolean method_13151(class_5821<PaleMossPatchCeilingConfig> context) {
        class_5281 world = context.method_33652();
        class_2338 origin = context.method_33655();
        PaleMossPatchCeilingConfig config = (PaleMossPatchCeilingConfig)context.method_33656();
