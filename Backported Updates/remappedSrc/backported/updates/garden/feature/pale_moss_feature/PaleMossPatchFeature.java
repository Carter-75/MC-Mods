...
public class PaleMossPatchFeature
extends class_3031<PaleMossPatchConfig> {
    public PaleMossPatchFeature(Codec<PaleMossPatchConfig> configCodec) {
        super(configCodec);
    }

    public boolean method_13151(class_5821<PaleMossPatchConfig> context) {
        class_5281 world = context.method_33652();
        class_2338 origin = context.method_33655();
        PaleMossPatchConfig config = (PaleMossPatchConfig)context.method_33656();
