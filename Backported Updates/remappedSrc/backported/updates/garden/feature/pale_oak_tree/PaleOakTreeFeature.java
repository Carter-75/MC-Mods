...
public class PaleOakTreeFeature
extends class_3031<PaleOakTreeFeatureConfig> {
    public PaleOakTreeFeature(Codec<PaleOakTreeFeatureConfig> configCodec) {
        super(configCodec);
    }

    public boolean method_13151(class_5821<PaleOakTreeFeatureConfig> context) {
        class_5281 world = context.method_33652();
        class_2338 origin = context.method_33655();
        PaleOakTreeFeatureConfig config = (PaleOakTreeFeatureConfig)context.method_33656();
