...
extends class_3031<PaleShortGrassPatchConfig> {
    public PaleShortGrassFeature(Codec<PaleShortGrassPatchConfig> configCodec) {
        super(configCodec);
    }

    public boolean method_13151(class_5821<PaleShortGrassPatchConfig> context) {
        class_5281 world = context.method_33652();
        class_2338 origin = context.method_33655();
        PaleShortGrassPatchConfig config = (PaleShortGrassPatchConfig)context.method_33656();
