...
public record PaleMossPatchBonemealConfig(int number, class_2960 blockId) implements class_3037
{
    public static final Codec<PaleMossPatchBonemealConfig> CODEC = RecordCodecBuilder.create(instance -> instance.group((App)class_5699.field_33442.fieldOf("number").forGetter(PaleMossPatchBonemealConfig::number), (App)class_2960.field_25139.fieldOf("blockID").forGetter(PaleMossPatchBonemealConfig::blockId)).apply((Applicative)instance, PaleMossPatchBonemealConfig::new));
}
