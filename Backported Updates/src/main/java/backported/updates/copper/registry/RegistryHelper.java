...
public abstract class RegistryHelper {
    ...
    public abstract <T> Supplier<T> register(RegistryKey<? extends Registry<? super T>> var1, String var2, Supplier<T> var3);

    public abstract <T> Supplier<T> registerWithNamespace(RegistryKey<? extends Registry<? super T>> var1, String var2, String var3, Supplier<T> var4);

    public <T> Supplier<T> registerAuto(RegistryKey<? extends Registry<? super T>> registry, String name, Supplier<T> supplier) {
    ...
    protected void fireRegistrationCallbacks() {
        ...
        Constants.LOG.info("Fired {} registration callbacks", this.registrationCallbacks.size());
    }
    ...
    protected Identifier id(String name) {
        return Identifier.of((String)"copperagebackport", (String)name);
    }

    protected Identifier minecraftId(String name) {
        return Identifier.ofVanilla((String)name);
    }
