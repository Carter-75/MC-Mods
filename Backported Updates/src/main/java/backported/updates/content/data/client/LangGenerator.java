...
extends FabricLanguageProvider {
    ...
    public void generateTranslations(RegistryWrapper.WrapperLookup provider, FabricLanguageProvider.TranslationBuilder builder) {
        ...
        builder.add((Block)((Supplier)ModBlocks.PALE_OAK_HANGING_SIGN.getFirst()).get(), "Pale Oak Hanging Sign");
        ...
        builder.add((Block)((Supplier)ModBlocks.PALE_OAK_SIGN.getFirst()).get(), "Pale Oak Sign");
