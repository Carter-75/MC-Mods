...
public class PaleOakChestBoat
extends ChestBoatEntity
implements PaleOakBoatBehavior {
    public PaleOakChestBoat(EntityType<? extends PaleOakChestBoat> entityType, World level) {
        super(entityType, level);
    }

    public PaleOakChestBoat(World level, double x, double y, double z) {
    ...
    protected void fall(double y, boolean onGround, BlockState state, BlockPos pos) {
        this.fall((BoatEntity)this, y, onGround);
    }
