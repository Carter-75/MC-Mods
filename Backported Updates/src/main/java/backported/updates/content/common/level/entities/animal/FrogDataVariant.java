...
{
    public static final Codec<FrogDataVariant> CODEC = RecordCodecBuilder.create(instance -> instance.group(ClientAsset.DEFAULT_FIELD_CODEC.forGetter(FrogDataVariant::assetInfo), SpawnPrioritySelectors.CODEC.fieldOf("spawn_conditions").forGetter(FrogDataVariant::spawnConditions)).apply(instance, FrogDataVariant::new));
