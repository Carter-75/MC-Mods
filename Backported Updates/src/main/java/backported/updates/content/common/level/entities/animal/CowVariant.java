...
{
    public static final PacketCodec<RegistryByteBuf, CowVariant> STREAM_CODEC = PacketCodecs.registryValue(ModRegistries.COW_VARIANT_KEY);
    public static final Codec<CowVariant> CODEC = RecordCodecBuilder.create(instance -> instance.group(ModelAndTexture.codec(ModelType.CODEC, ModelType.NORMAL).forGetter(CowVariant::modelAndTexture), SpawnPrioritySelectors.CODEC.fieldOf("spawn_conditions").forGetter(CowVariant::spawnConditions)).apply(instance, CowVariant::new));
