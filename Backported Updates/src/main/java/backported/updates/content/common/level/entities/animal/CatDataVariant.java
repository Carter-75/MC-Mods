...
{
    public static final Codec<CatDataVariant> CODEC = RecordCodecBuilder.create(instance -> instance.group(ClientAsset.DEFAULT_FIELD_CODEC.forGetter(CatDataVariant::assetInfo), SpawnPrioritySelectors.CODEC.fieldOf("spawn_conditions").forGetter(CatDataVariant::spawnConditions)).apply(instance, CatDataVariant::new));
