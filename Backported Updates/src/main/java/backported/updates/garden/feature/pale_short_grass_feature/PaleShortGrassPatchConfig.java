...
{
    public static final Codec<PaleShortGrassPatchConfig> CODEC = RecordCodecBuilder.create(instance -> instance.group(Codecs.POSITIVE_INT.fieldOf("number").forGetter(PaleShortGrassPatchConfig::number), Identifier.CODEC.fieldOf("blockID").forGetter(PaleShortGrassPatchConfig::blockId)).apply(instance, PaleShortGrassPatchConfig::new));
}
