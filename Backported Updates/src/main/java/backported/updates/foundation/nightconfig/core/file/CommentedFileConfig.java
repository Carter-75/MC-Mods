...
FileConfig {
    ...
    public static CommentedFileConfig of(Path file) {
        ...
        return CommentedFileConfig.of(file, (ConfigFormat<? extends CommentedConfig>)format);
    }
    ...
    public static CommentedFileConfigBuilder builder(Path file) {
        ...
        return CommentedFileConfig.builder(file, (ConfigFormat<? extends CommentedConfig>)format);
    }
