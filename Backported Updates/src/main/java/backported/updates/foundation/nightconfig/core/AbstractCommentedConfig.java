...
implements CommentedConfig {
    ...
    public AbstractCommentedConfig(Supplier<Map<String, Object>> mapCreator) {
        super(mapCreator);
        this.commentMap = (Map<String, String>)AbstractConfig.getWildcardMapCreator(mapCreator).get();
    }
    ...
    protected static Map<String, String> getDefaultCommentMap(boolean concurrent) {
        return (Map<String, String>)AbstractConfig.getDefaultMapCreator(concurrent).get();
    }
    ...
    public Set<? extends CommentedConfig.Entry> entrySet() {
        return (Set<? extends CommentedConfig.Entry>)new TransformingSet<Map.Entry, CommentedEntryWrapper>(this.map.entrySet(), x$0 -> new CommentedEntryWrapper((Map.Entry<String, Object>)x$0), o -> null, o -> o);
    }
