    ...
    public Set<? extends CommentedConfig.Entry> entrySet() {
        Function<CommentedConfig.Entry, CommentedConfig.Entry> readTransfo = entry -> new CommentedConfig.Entry(){
            ...
            public <T> T setValue(Object value) {
                return (T)AbstractConvertedCommentedConfig.this.readConversion.apply(entry.setValue(AbstractConvertedCommentedConfig.this.writeConversion.apply(value)));
            }
        };
        return (Set<? extends CommentedConfig.Entry>)new TransformingSet<CommentedConfig.Entry, CommentedConfig.Entry>(((CommentedConfig)this.config).entrySet(), readTransfo, o -> null, e -> e);
    }
