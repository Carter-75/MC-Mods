...
implements IConfigSpec<SimpleConfigSpec> {
    ...
    public void setConfig(CommentedConfig config) {
        ...
        if (config != null && !this.isCorrect(config)) {
            ...
            this.correct(config, (action, path, incorrectValue, correctedValue) -> LOGGER.warn("Incorrect key {} was corrected from {} to its default, {}. {}", DOT_JOINER.join((Iterable)path), incorrectValue, correctedValue, (incorrectValue == correctedValue ? "This seems to be an error." : "")), (action, path, incorrectValue, correctedValue) -> LOGGER.debug("The comment on key {} does not match the spec. This may create a backup.", DOT_JOINER.join((Iterable)path)));
    ...
    implements Predicate<Object> {
        ...
        public boolean test(Object t) {
            ...
            Comparable c = this.clazz.cast(t);
        ...
        public Object correct(Object value, Object def) {
            ...
            Comparable c = this.clazz.cast(value);
