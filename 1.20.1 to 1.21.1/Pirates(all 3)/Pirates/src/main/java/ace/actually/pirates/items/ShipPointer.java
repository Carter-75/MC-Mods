...
extends class_1792 {
    public ShipPointer(class_1792.class_1793 settings) {
        super(settings);
    }
        ...
        if (class_19372 instanceof class_3218) {
            ...
            if (context.method_20287() == class_1268.field_5808) {
                if (world.method_8320(context.method_8037()).method_27852((class_2248)Pirates.MOTION_INVOKING_BLOCK.get())) {
                    ...
                    be.setTarget(new int[]{pos.method_10263(), pos.method_10264(), pos.method_10260()});
                } else {
    ...
    public class_1271<class_1799> method_7836(class_1937 world, class_1657 user, class_1268 hand) {
        if (class_1268.field_5808 == hand && !world.field_9236) {
