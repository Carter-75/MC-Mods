...
@Metadata(mv={1, 8, 0}, k=1, xi=48, d1={"\u0000\f\n\u0002\u0018\u0002\n\u0002\u0010\u001b\n\u0002\b\u0003\b\u0087\u0002\u0018\u00002\u00020\u0001B\u0007\u00a2\u0006\u0004\b\u0002\u0010\u0003\u00a8\u0006\u0004"}, d2={"Lorg/valkyrienskies/core/api/util/PhysTickOnly;", "", "<init>", "()V", "api"})
@RequiresOptIn(message="This is a Physics Thread only class or method. Ensure you are not accessing it, directly or by reference, from the Game Thread!", level=RequiresOptIn.Level.WARNING)
public @interface PhysTickOnly {
}
