...
public class dn_2
extends ct_2 {
    private static String d = "https://json-schema.org/draft-06/schema";
    private static final String e = "$id";

    @Override
    co_2 a() {
        return new co_2.a(d).a(e).b(c).a(dj_2.a(cu_1.a.V6)).a(Arrays.asList(new cg_1("$schema"), new cg_1(e), new cg_1("title"), new cg_1("description"), new cg_1("default"), new cg_1("definitions"))).a();
    }
}
