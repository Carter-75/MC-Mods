 ...
 * Renamed from org.valkyrienskies.core.impl.shadow.px
 */
public enum px_0 implements pw_0
{
    ...
    public final String a(Locale locale) {
        try {
            Object object = px_0.class.getName().replaceAll("\\.", "/");
            object = ResourceBundle.getBundle("assets/" + (String)object, locale);
