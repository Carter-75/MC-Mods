...
implements bj_0 {
    public final bl_0 a(int n2, int n3, double d2) {
        ...
        double d5 = BY.a(d4, 2);
        double d6 = (double)n3 / (double)n2;
        double d7 = 1.0 / (1.0 + 1.0 / (double)n2 * d5);
        double d8 = d6 + 1.0 / (double)(2 * n2) * d5;
        double d9 = d4 * BY.a(1.0 / (double)n2 * d6 * (1.0 - d6) + 1.0 / (4.0 * BY.a((double)n2, 2)) * d5);
        double d10 = d7 * (d8 - d9);
        double d11 = d7 * (d8 + d9);
        return new bl_0(d10, d11, d2);
    }
}
