...
extends class_1792 {
    ...
    public ConnectionCheckerItem(@NotNull class_1792.class_1793 properties, @NotNull DoubleSupplier scale, @NotNull DoubleSupplier minScaling) {
    ...
    public class_1269 method_7884(@NotNull class_1838 ctx) {
        block6: {
            ...
            if (!(item.method_7909() instanceof ConnectionCheckerItem)) {
                return class_1269.field_5814;
            }
            if (level.field_9236) break block6;
            v3 = ctx.method_8045();
            Intrinsics.checkNotNull((Object)blockPos);
            parentShip = VSGameUtilsKt.getShipManagingPos(v3, blockPos);
            if (blockState.method_26215()) break block6;
            dimensionId = VSGameUtilsKt.getDimensionId((class_1937)level);
            if (parentShip == null) break block6;
            if (item.method_7969() == null) ** GOTO lbl-1000
            v4 = item.method_7969();
            Intrinsics.checkNotNull((Object)v4);
            if (v4.method_10545("firstPosX")) {
                v5 = item.method_7969();
                Intrinsics.checkNotNull((Object)v5);
                firstPosX = v5.method_10550("firstPosX");
                v6 = item.method_7969();
                Intrinsics.checkNotNull((Object)v6);
                firstPosY = v6.method_10550("firstPosY");
                v7 = item.method_7969();
                Intrinsics.checkNotNull((Object)v7);
                firstPosZ = v7.method_10550("firstPosZ");
                connected = VSGameUtilsKt.getShipObjectWorld(level).isConnectedBySolid(blockPos.method_10263(), blockPos.method_10264(), blockPos.method_10260(), firstPosX, firstPosY, firstPosZ, dimensionId);
                v8 = ctx.method_8036();
                if (v8 != null) {
                    v8.method_43496((class_2561)class_2561.method_43471((String)("Connected: " + connected)));
                }
                v9 = item.method_7969();
                Intrinsics.checkNotNull((Object)v9);
                v9.method_10551("firstPosX");
                v10 = item.method_7969();
                Intrinsics.checkNotNull((Object)v10);
                v10.method_10551("firstPosY");
                v11 = item.method_7969();
                Intrinsics.checkNotNull((Object)v11);
                v11.method_10551("firstPosZ");
            } else lbl-1000:
            // 2 sources

            {
                firstPosY = var8_9 = item.method_7948();
                var12_15 = item;
                $i$a$-apply-ConnectionCheckerItem$useOn$1 = false;
                ...
                var12_15.method_7980(var8_9);
                v12 = ctx.method_8036();
                if (v12 != null) {
                    v12.method_43496((class_2561)class_2561.method_43471((String)("First block selected: (" + blockPos.method_10263() + ", " + blockPos.method_10264() + ", " + blockPos.method_10260() + ")")));
                }
            }
        }
        v13 = super.method_7884(ctx);
        Intrinsics.checkNotNullExpressionValue((Object)v13, (String)"useOn(...)");
        return v13;
    }
}
