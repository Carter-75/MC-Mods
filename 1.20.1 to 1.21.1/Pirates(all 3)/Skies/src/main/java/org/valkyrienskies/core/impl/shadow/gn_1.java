 ...
 */
public final class gn_1<T>
extends gk_1<T> {
    private static final long b = 7429999530934647542L;
    ...
    public static <T> ff_1<T> a(ff_1<? super T> ... ff_1Array) {
        ...
        return new gn_1<T>(hf_2.a(ff_1Array));
    }
    ...
    public static <T> ff_1<T> a(Collection<? extends ff_1<? super T>> ff_1Array) {
        ...
        return new gn_1(ff_1Array);
    }

    private gn_1(ff_1<? super T> ... ff_1Array) {
        super(ff_1Array);
    }
