...
/*
 * Renamed from org.valkyrienskies.core.impl.shadow.yh
 */
@Deprecated
public final class yh_0
implements kW {
    private final kY a;
    ...
    private yh_0(kY kY2, double[] dArray) {
        this.a = kY2;
    ...
    private yh_0(kY kY2, double[] dArray, double[] dArray2) {
    ...
    private yh_0(kY kY2, double[] dArray, tq_0 tq_02) {
