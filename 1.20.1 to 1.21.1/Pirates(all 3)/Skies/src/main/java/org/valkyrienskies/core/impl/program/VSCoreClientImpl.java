...
VsiCoreClient {
     ...
     */
    @Inject
    public VSCoreClientImpl(VSCoreImpl base, ShipObjectClientWorldComponent.Factory shipWorldComponentFactory) {
        void var2_2;
        void var1_1;
        Intrinsics.checkNotNullParameter((Object)base, (String)"");
        Intrinsics.checkNotNullParameter((Object)shipWorldComponentFactory, (String)"");
        this.base = var1_1;
        this.shipWorldComponentFactory = var2_2;
    }
    ...
    @Override
    public final VsiClientShipWorld newShipWorldClient() {
