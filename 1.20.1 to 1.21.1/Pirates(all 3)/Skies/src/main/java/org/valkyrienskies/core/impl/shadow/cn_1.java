...
extends bt_1
implements cv_2 {
    private static final Logger g = LoggerFactory.getLogger(cn_1.class);
    ...
    public cn_1(String string, JsonNode object, cp_2 cp_22, df_2 df_22) {
    ...
    private void a(HashSet<dg_2> hashSet, int n2, JsonNode jsonNode, JsonNode jsonNode2, String string, boolean bl) {
        if (this.j != null) {
            cn_1 cn_12 = this;
            cn_12.a(cn_12.j, jsonNode, jsonNode2, string + "[" + n2 + "]", bl, hashSet);
        }
        if (this.k != null) {
            if (n2 < this.k.size()) {
                cn_1 cn_13 = this;
                cn_13.a(cn_13.k.get(n2), jsonNode, jsonNode2, string + "[" + n2 + "]", bl, hashSet);
                return;
            }
            if (this.m != null) {
                cn_1 cn_14 = this;
                cn_14.a(cn_14.m, jsonNode, jsonNode2, string + "[" + n2 + "]", bl, hashSet);
            }
        }
    }
