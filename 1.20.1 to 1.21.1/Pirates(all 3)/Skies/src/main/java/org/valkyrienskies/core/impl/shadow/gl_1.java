 ...
 */
public final class gl_1<T>
extends gk_1<T> {
    private static final long b = -3094696765038308799L;

    public static <T> ff_1<T> a(ff_1<? super T> ... object) {
        hf_2.b(object);
        if (((ff_1<? super T>[])object).length == 0) {
            return hi_1.a();
        }
        if (((ff_1<? super T>[])object).length == 1) {
            object = object[0];
            return object;
        }
        return new gl_1<T>(hf_2.a(object));
    }

    public static <T> ff_1<T> a(Collection<? extends ff_1<? super T>> object) {
        if (((ff_1<T>[])(object = hf_2.a(object))).length == 0) {
            return hi_1.a();
        }
        if (((ff_1<T>[])object).length == 1) {
            object = object[0];
            return object;
        }
        return new gl_1(object);
    }

    private gl_1(ff_1<? super T> ... ff_1Array) {
        super(ff_1Array);
    }
