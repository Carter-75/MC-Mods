...
extends bt_1
implements cv_2 {
    private static final Logger g = LoggerFactory.getLogger(cy_1.class);

    public cy_1(String string, JsonNode jsonNode, cp_2 cp_22, df_2 df_22) {
        super(string, jsonNode, cp_22, dj_2.TRUE, df_22);
    }
