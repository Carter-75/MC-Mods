...
import org.valkyrienskies.core.impl.program.VSCoreClientFactory;
...
import org.valkyrienskies.core.impl.shadow.EE;
import org.valkyrienskies.core.impl.shadow.EF;
...
public final class DaggerVSCoreClientFactory {
    ...
    public static final class Builder {
        ...
        public final VSCoreClientFactory build() {
            ...
            return new VSCoreClientFactoryImpl(this.vSCoreModule, this.vSJacksonModule, this.vSPipelineChainUpdaterModule);
        }
    }

    static final class VSCoreClientFactoryImpl
    implements VSCoreClientFactory {
        final VSCoreModule vSCoreModule;
        final VSCoreClientFactoryImpl vSCoreClientFactoryImpl = this;
         ...
         * WARNING - void declaration
         */
        VSCoreClientFactoryImpl(VSCoreModule vSCoreModuleParam, GG vSJacksonModuleParam, VSPipelineChainUpdaterModule vSPipelineChainUpdaterModuleParam) {
            void var3_3;
            void var2_2;
            void var1_1;
        ...
        private void initialize(VSCoreModule vSCoreModuleParam, GG vSJacksonModuleParam, VSPipelineChainUpdaterModule vSPipelineChainUpdaterModuleParam) {
            ...
            this.vSPipelineComponentFactoryProvider = new ew_2<FL.a>(this){
                final /* synthetic */ VSCoreClientFactoryImpl this$0;
                {
                    void var1_1;
                    this.this$0 = var1_1;
                }
                ...
                @Override
                public FL.a get() {
                    return new VSPipelineComponentFactory(this.this$0.vSCoreClientFactoryImpl);
                }
            };
        ...
        @Override
        public final VSCoreClientImpl client() {
            return new VSCoreClientImpl((VSCoreImpl)this.vSCoreImplProvider.get(), new ShipObjectClientWorldComponentFactory(this.vSCoreClientFactoryImpl));
        }
    }

    static final class ShipObjectClientWorldComponentImpl
    implements ShipObjectClientWorldComponent {
        private final VSCoreClientFactoryImpl vSCoreClientFactoryImpl;
        private final ShipObjectClientWorldComponentImpl shipObjectClientWorldComponentImpl = this;
        private EM shipObjectNetworkManagerClientProvider;
        private ew_2<EL.b> factoryProvider;
        ...
        private ew_2<ShipObjectClientWorld> shipObjectClientWorldProvider;

        /*
         * WARNING - void declaration
         */
        ShipObjectClientWorldComponentImpl(VSCoreClientFactoryImpl vSCoreClientFactoryImpl, EC clientShipWorldModuleParam) {
            void var2_2;
            void var1_1;
            this.vSCoreClientFactoryImpl = var1_1;
            this.initialize((EC)var2_2);
        }

        /*
         * WARNING - void declaration
         */
        private void initialize(EC clientShipWorldModuleParam) {
            void var1_1;
            this.shipObjectNetworkManagerClientProvider = EM.a(this.vSCoreClientFactoryImpl.vSNetworkingProvider, this.vSCoreClientFactoryImpl.simplePacketNetworkingProvider, this.vSCoreClientFactoryImpl.packetsProvider);
            this.factoryProvider = EN.a((EM)this.shipObjectNetworkManagerClientProvider);
            this.getDimensionInfoProvider = ej_2.a(EE.a(clientShipWorldModuleParam));
            this.connectivityHandlerProvider = DX.a(this.getDimensionInfoProvider, ea_0.a(), ED.a());
            this.getMutableDimensionInfoProvider = ej_2.a(EF.a((EC)var1_1));
            this.shipObjectClientWorldProvider = ej_2.a(ShipObjectClientWorld_Factory.create(this.factoryProvider, ED.a(), this.vSCoreClientFactoryImpl.blockTypesImplProvider, this.connectivityHandlerProvider, this.getMutableDimensionInfoProvider));
        }

        @Override
        public final ShipObjectClientWorld newWorld() {
            return (ShipObjectClientWorld)this.shipObjectClientWorldProvider.get();
        }
    }
    ...
    implements FL {
         ...
         * WARNING - void declaration
         */
        VSPipelineComponentImpl(VSCoreClientFactoryImpl vSCoreClientFactoryImpl, EG shipWorldModuleParam) {
            void var2_2;
            void var1_1;
            this.vSCoreClientFactoryImpl = var1_1;
        ...
        private void initialize(EG shipWorldModuleParam) {
            ...
            this.shipObjectNetworkManagerServerProvider = EP.a(this.shipObjectServerWorldProvider, this.vSCoreClientFactoryImpl.tcpProvider, this.vSCoreClientFactoryImpl.udpProvider, this.vSCoreClientFactoryImpl.simplePacketNetworkingProvider, this.vSCoreClientFactoryImpl.packetsProvider);
            this.getDimensionInfoProvider = ej_2.a(EJ.a(shipWorldModuleParam));
            this.shipObjectServerWorldChunkTrackerProvider = CZ.a(this.vSCoreClientFactoryImpl.serverConfigProvider, this.getDimensionInfoProvider);
            this.shipObjectServerWorldPhysEntityTrackerProvider = fw_0.a(this.vSCoreClientFactoryImpl.serverConfigProvider);
            ...
            this.factoryProvider = ShipData_Factory_Factory.create(this.vSCoreClientFactoryImpl.attachmentHolderFactoryProvider);
            ei_2.a(this.shipObjectServerWorldProvider, ej_2.a(es_0.a(this.getAllShipsProvider, this.singletonChunkAllocatorProviderImplProvider, this.shipLoadManagerServerProvider, this.vSCoreClientFactoryImpl.vSNetworkingProvider, this.vSCoreClientFactoryImpl.blockTypesImplProvider, this.getMutableDimensionInfoProvider, this.connectivityHandlerProvider, this.factoryProvider, this.vSCoreClientFactoryImpl.vSCoreImplProvider)));
            this.vSGamePipelineStageProvider = FE.a(this.shipObjectServerWorldProvider, this.vSCoreClientFactoryImpl.vSCoreImplProvider);
            this.vSPhysicsPipelineStageProvider = FK.a(this.vSCoreClientFactoryImpl.blockTypesImplProvider, this.vSCoreClientFactoryImpl.getPhysicsThreadCheckerProvider, this.shipObjectServerWorldProvider, this.vSCoreClientFactoryImpl.vSCoreImplProvider);
            this.vSNetworkPipelineStageProvider = FG.a(this.shipObjectServerWorldProvider, this.vSCoreClientFactoryImpl.vSNetworkingProvider, this.vSCoreClientFactoryImpl.packetsProvider);
            this.vsiPipelineImplProvider = ej_2.a(FN.a(this.shipObjectServerWorldProvider, this.vSGamePipelineStageProvider, this.vSPhysicsPipelineStageProvider, this.vSNetworkPipelineStageProvider, this.vSCoreClientFactoryImpl.coreHooksImplProvider));
        }
        ...
        public final FJ newPhysicsStage() {
            return new FJ((DN)this.vSCoreClientFactoryImpl.blockTypesImplProvider.get(), VSCoreModule_GetPhysicsThreadCheckerFactory.getPhysicsThreadChecker(this.vSCoreClientFactoryImpl.vSCoreModule), (er_0)this.shipObjectServerWorldProvider.get(), this.vSCoreClientFactoryImpl.vSCoreImplProvider);
        }
    }

    static final class ShipObjectClientWorldComponentFactory
    implements ShipObjectClientWorldComponent.Factory {
        private final VSCoreClientFactoryImpl vSCoreClientFactoryImpl;

        /*
         * WARNING - void declaration
         */
        ShipObjectClientWorldComponentFactory(VSCoreClientFactoryImpl vSCoreClientFactoryImpl) {
            void var1_1;
            this.vSCoreClientFactoryImpl = var1_1;
        }

        @Override
        public final ShipObjectClientWorldComponent newShipObjectClientWorldComponent() {
            return new ShipObjectClientWorldComponentImpl(this.vSCoreClientFactoryImpl, new EC());
        }
    }
    ...
    implements FL.a {
         ...
         * WARNING - void declaration
         */
        VSPipelineComponentFactory(VSCoreClientFactoryImpl vSCoreClientFactoryImpl) {
            void var1_1;
            this.vSCoreClientFactoryImpl = var1_1;
        }
        ...
        public final FL newPipelineComponent(EG module) {
            void var1_1;
            ev_2.a(module);
            return new VSPipelineComponentImpl(this.vSCoreClientFactoryImpl, (EG)var1_1);
        }
    }
}
