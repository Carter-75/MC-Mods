 ...
 */
public final class go_2<K, V>
extends gl_2<K, V>
implements Serializable {
    private static final long d = 721969328361808L;

    public go_2() {
        super(new HashMap(), new HashMap());
    }

    private go_2(Map<? extends K, ? extends V> map2) {
        super(new HashMap(), new HashMap());
        this.putAll(map2);
    }

    private go_2(Map<K, V> map2, Map<V, K> map3, ey_1<V, K> ey_12) {
    ...
    protected final gl_2 a(Map map2, Map map3, gl_2 gl_22) {
        return new go_2<K, V>(map2, map3, gl_22);
    }
