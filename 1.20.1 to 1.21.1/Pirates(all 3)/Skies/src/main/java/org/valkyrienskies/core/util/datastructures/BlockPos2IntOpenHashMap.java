...
public final class BlockPos2IntOpenHashMap {
    ...
    public BlockPos2IntOpenHashMap(int expected, float loadFactor) {
        this.f = loadFactor;
    ...
    public /* synthetic */ BlockPos2IntOpenHashMap(int n2, float f2, int n3, DefaultConstructorMarker defaultConstructorMarker) {
        if ((n3 & 1) != 0) {
            n2 = 10;
        }
        if ((n3 & 2) != 0) {
    ...
    public final void setDefRetValue(int n2) {
        this.defRetValue = n2;
    }
    ...
    public final int put(int x, int y, int z, int v) {
        int pos = this.find(x, y, z);
        if (pos < 0) {
    ...
    public final int remove(int x, int y, int z) {
        if (x == 0 && y == 0 && z == 0) {
    ...
    private final int removeNullEntry() {
        ...
        int oldValue = this.values[this.n];
        int n2 = this.size;
        this.size = n2 + -1;
    ...
    private final void insert(int pos, int x, int y, int z, int v) {
        if (pos == this.n) {
