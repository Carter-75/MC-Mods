...
/*
 * Renamed from org.valkyrienskies.core.impl.shadow.hy
 */
public final class hy_2<T>
implements Serializable,
hz_2<T> {
    private static final long a = -8791518325735182855L;
    ...
    public static <T> ff_1<T> a(ff_1<? super T> ff_12, ff_1<? super T> ff_13) {
        ...
        return new hy_2<T>(ff_12, ff_13);
    }

    private hy_2(ff_1<? super T> ff_12, ff_1<? super T> ff_13) {
        this.b = ff_12;
        this.c = ff_13;
    }
