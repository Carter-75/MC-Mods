...
public class ArrayUtils {
    ...
    public static <E> List<E> toUnmodifiableCompositeList(E[] array1, E[] array2) {
        List<E> result2 = array1.length == 0 ? ArrayUtils.toUnmodifiableList(array2) : (array2.length == 0 ? ArrayUtils.toUnmodifiableList(array1) : new CompositeUnmodifiableArrayList<E>(array1, array2));
        return result2;
    }
