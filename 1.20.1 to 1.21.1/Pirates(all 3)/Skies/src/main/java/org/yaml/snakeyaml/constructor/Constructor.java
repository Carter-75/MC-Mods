    ...
    extends AbstractConstruct {
        ...
        public Object construct(Node nnode) {
            ...
            if (type.isPrimitive() || type == String.class || Number.class.isAssignableFrom(type) || type == Boolean.class || Date.class.isAssignableFrom(type) || type == Character.class || type == BigInteger.class || type == BigDecimal.class || Enum.class.isAssignableFrom(type) || Tag.BINARY.equals(node.getTag()) || Calendar.class.isAssignableFrom(type) || type == UUID.class) {
                result2 = this.constructStandardJavaInstance(type, node);
            } else {
                Object argument;
                ...
                try {
                    ...
                    result2 = javaConstructor.newInstance(argument);
                }
                catch (Exception e3) {
        ...
        private Object constructStandardJavaInstance(Class type, ScalarNode node) {
            ...
            if (type == String.class) {
                ...
                if (ch.length() == 0) {
                    ...
                    result2 = Character.valueOf(ch.charAt(0));
                }
                ...
                if (type == Date.class) {
                    ...
                    try {
                        ...
                        result2 = constr.newInstance(date.getTime());
                    }
                ...
                if (type == BigDecimal.class) {
                    result2 = new BigDecimal(node.getValue());
                } else {
                    Construct doubleConstructor = (Construct)Constructor.this.yamlConstructors.get(Tag.FLOAT);
                    result2 = doubleConstructor.construct(node);
                    if (type == Float.class || type == Float.TYPE) {
                        result2 = Float.valueOf(((Double)result2).floatValue());
                    }
                }
                ...
                result2 = intConstructor.construct(node);
                result2 = type == Byte.class || type == Byte.TYPE ? (Number)Integer.valueOf(result2.toString()).byteValue() : (Number)(type == Short.class || type == Short.TYPE ? (Number)Integer.valueOf(result2.toString()).shortValue() : (Number)(type == Integer.class || type == Integer.TYPE ? (Number)Integer.parseInt(result2.toString()) : (Number)(type == Long.class || type == Long.TYPE ? Long.valueOf(result2.toString()) : new BigInteger(result2.toString()))));
            } else if (Enum.class.isAssignableFrom(type)) {
                String enumValueName = node.getValue();
                try {
                    if (Constructor.this.loadingConfig.isEnumCaseSensitive()) {
                        result2 = Enum.valueOf(type, enumValueName);
                    }
                    result2 = EnumUtils.findEnumInsensitiveCase(type, enumValueName);
                }
                catch (Exception ex) {
