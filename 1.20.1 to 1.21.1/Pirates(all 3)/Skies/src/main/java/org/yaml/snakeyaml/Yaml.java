...
public class Yaml {
    ...
    public Iterable<Object> loadAll(Reader yaml) {
        ...
        this.constructor.setComposer(composer);
        Iterator<Object> result2 = new Iterator<Object>(){
        ...
        return new YamlIterable(result2);
    }
    ...
    public Iterable<Node> composeAll(Reader yaml) {
        ...
        Iterator<Node> result2 = new Iterator<Node>(){
        ...
        return new NodeIterable(result2);
    }

    public void addImplicitResolver(Tag tag, Pattern regexp, String first2) {
        this.resolver.addImplicitResolver(tag, regexp, first2);
    }

    public void addImplicitResolver(Tag tag, Pattern regexp, String first2, int limit) {
        this.resolver.addImplicitResolver(tag, regexp, first2, limit);
    }
    ...
    public Iterable<Event> parse(Reader yaml) {
        ...
        Iterator<Event> result2 = new Iterator<Event>(){
        ...
        return new EventIterable(result2);
    }
