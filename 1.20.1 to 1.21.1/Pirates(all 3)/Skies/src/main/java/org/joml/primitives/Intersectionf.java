...
public class Intersectionf {
    ...
    public static boolean testPlaneSphere(Planef plane, Spheref sphere) {
        return Intersectionf.testPlaneSphere(plane.a, plane.b, plane.c, plane.d, sphere.x, sphere.y, sphere.z, sphere.r);
    }
    ...
    public static boolean testAabPlane(AABBf aabb, Planef plane) {
        return Intersectionf.testAabPlane(aabb.minX, aabb.minY, aabb.minZ, aabb.maxX, aabb.maxY, aabb.maxZ, plane.a, plane.b, plane.c, plane.d);
    }
    ...
    public static boolean testAabAab(AABBf aabb1, AABBf aabb2) {
        return Intersectionf.testAabAab(aabb1.minX, aabb1.minY, aabb1.minZ, aabb1.maxX, aabb1.maxY, aabb1.maxZ, aabb2.minX, aabb2.minY, aabb2.minZ, aabb2.maxX, aabb2.maxY, aabb2.maxZ);
    }
    ...
    public static boolean intersectSphereSphere(Spheref sphereA, Spheref sphereB, Vector4f centerAndRadiusOfIntersectionCircle) {
        return Intersectionf.intersectSphereSphere(sphereA.x, sphereA.y, sphereA.z, sphereA.r * sphereA.r, sphereB.x, sphereB.y, sphereB.z, sphereB.r * sphereB.r, centerAndRadiusOfIntersectionCircle);
    }
    ...
    public static float intersectRayPlane(Rayf ray, Planef plane, float epsilon) {
        return Intersectionf.intersectRayPlane(ray.oX, ray.oY, ray.oZ, ray.dX, ray.dY, ray.dZ, plane.a, plane.b, plane.c, plane.d, epsilon);
    }
    ...
    public static boolean testAabSphere(AABBf aabb, Spheref sphere) {
        return Intersectionf.testAabSphere(aabb.minX, aabb.minY, aabb.minZ, aabb.maxX, aabb.maxY, aabb.maxZ, sphere.x, sphere.y, sphere.z, sphere.r * sphere.r);
    }
    ...
    public static boolean intersectRaySphere(Rayf ray, Spheref sphere, Vector2f result2) {
        return Intersectionf.intersectRaySphere(ray.oX, ray.oY, ray.oZ, ray.dX, ray.dY, ray.dZ, sphere.x, sphere.y, sphere.z, sphere.r * sphere.r, result2);
    }
    ...
    public static boolean testRaySphere(Rayf ray, Spheref sphere) {
        return Intersectionf.testRaySphere(ray.oX, ray.oY, ray.oZ, ray.dX, ray.dY, ray.dZ, sphere.x, sphere.y, sphere.z, sphere.r * sphere.r);
    }
    ...
    public static boolean intersectRayAab(Rayf ray, AABBf aabb, Vector2f result2) {
        return Intersectionf.intersectRayAab(ray.oX, ray.oY, ray.oZ, ray.dX, ray.dY, ray.dZ, aabb.minX, aabb.minY, aabb.minZ, aabb.maxX, aabb.maxY, aabb.maxZ, result2);
    }

    public static boolean intersectRayAab(Rayf ray, AABBi aabb, Vector2f result2) {
        return Intersectionf.intersectRayAab(ray.oX, ray.oY, ray.oZ, ray.dX, ray.dY, ray.dZ, aabb.minX, aabb.minY, aabb.minZ, aabb.maxX, aabb.maxY, aabb.maxZ, result2);
    }
    ...
    public static int intersectLineSegmentAab(LineSegmentf lineSegment, AABBf aabb, Vector2f result2) {
        return Intersectionf.intersectLineSegmentAab(lineSegment.aX, lineSegment.aY, lineSegment.aZ, lineSegment.bX, lineSegment.bY, lineSegment.bZ, aabb.minX, aabb.minY, aabb.minZ, aabb.maxX, aabb.maxY, aabb.maxZ, result2);
    }

    public static int intersectLineSegmentAab(LineSegmentf lineSegment, AABBi aabb, Vector2f result2) {
        return Intersectionf.intersectLineSegmentAab(lineSegment.aX, lineSegment.aY, lineSegment.aZ, lineSegment.bX, lineSegment.bY, lineSegment.bZ, aabb.minX, aabb.minY, aabb.minZ, aabb.maxX, aabb.maxY, aabb.maxZ, result2);
    }
    ...
    public static boolean testRayAab(Rayf ray, AABBf aabb) {
        return Intersectionf.testRayAab(ray.oX, ray.oY, ray.oZ, ray.dX, ray.dY, ray.dZ, aabb.minX, aabb.minY, aabb.minZ, aabb.maxX, aabb.maxY, aabb.maxZ);
    }
