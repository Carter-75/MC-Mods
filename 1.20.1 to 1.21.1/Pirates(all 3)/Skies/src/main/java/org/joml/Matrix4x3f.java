...
Matrix4x3fc {
    ...
    public Matrix4x3f set(AxisAngle4f axisAngle) {
        ...
        float n2 = Math.sqrt(x * x + y * y + z * z);
        n2 = 1.0f / n2;
        x *= n2;
        y *= n2;
        z *= n2;
    ...
    public Matrix4x3f set(AxisAngle4d axisAngle) {
        ...
        double omc = 1.0 - c2;
        this.m00 = (float)(c2 + x * x * omc);
        this.m11 = (float)(c2 + y * y * omc);
        this.m22 = (float)(c2 + z * z * omc);
        double tmp1 = x * y * omc;
        double tmp2 = z * s;
    ...
    private Matrix4x3f rotationInternal(float angle, float x, float y, float z) {
        ...
        float yz = y * z;
        this.m00 = cos + x * x * C2;
        this.m01 = xy * C2 + z * sin;
        this.m02 = xz * C2 - y * sin;
        this.m10 = xy * C2 - z * sin;
        this.m11 = cos + y * y * C2;
        this.m12 = yz * C2 + x * sin;
        this.m20 = xz * C2 + y * sin;
        this.m21 = yz * C2 - x * sin;
        this.m22 = cos + z * z * C2;
        this.m30 = 0.0f;
        this.m31 = 0.0f;
        this.m32 = 0.0f;
    ...
    public Matrix4x3f translationRotateScaleMul(float tx, float ty, float tz, float qx, float qy, float qz, float qw, float sx, float sy, float sz, Matrix4x3f m2) {
        float dqx = qx + qx;
        float dqy = qy + qy;
        float dqz = qz + qz;
        float q00 = dqx * qx;
    ...
    public Matrix4x3f translate(float x, float y, float z) {
        ...
        Matrix4x3f c2 = this;
        c2.m30 = c2.m00 * x + c2.m10 * y + c2.m20 * z + c2.m30;
        c2.m31 = c2.m01 * x + c2.m11 * y + c2.m21 * z + c2.m31;
        c2.m32 = c2.m02 * x + c2.m12 * y + c2.m22 * z + c2.m32;
