    ...
    extends MemUtilNIO {
        ...
        private static long checkMatrix4f() throws NoSuchFieldException, SecurityException {
            ...
            for (int i2 = 1; i2 < 16; ++i2) {
                int c2 = i2 >>> 2;
                int r = i2 & 3;
                f2 = (class$1 == null ? MemUtilUnsafe.class$("org.joml.Matrix4f") : class$1).getDeclaredField("m" + c2 + r);
        ...
        private static long checkMatrix4d() throws NoSuchFieldException, SecurityException {
            ...
            for (int i2 = 1; i2 < 16; ++i2) {
                int c2 = i2 >>> 2;
                int r = i2 & 3;
                f2 = (class$2 == null ? MemUtilUnsafe.class$("org.joml.Matrix4d") : class$2).getDeclaredField("m" + c2 + r);
                long offset = UNSAFE.objectFieldOffset(f2);
        ...
        private static long checkMatrix4x3f() throws NoSuchFieldException, SecurityException {
            ...
            for (int i2 = 1; i2 < 12; ++i2) {
                int c2 = i2 / 3;
                int r = i2 % 3;
                f2 = (class$3 == null ? MemUtilUnsafe.class$("org.joml.Matrix4x3f") : class$3).getDeclaredField("m" + c2 + r);
                long offset = UNSAFE.objectFieldOffset(f2);
        ...
        private static long checkMatrix3f() throws NoSuchFieldException, SecurityException {
            ...
            for (int i2 = 1; i2 < 9; ++i2) {
                int c2 = i2 / 3;
                int r = i2 % 3;
                f2 = (class$4 == null ? MemUtilUnsafe.class$("org.joml.Matrix3f") : class$4).getDeclaredField("m" + c2 + r);
                long offset = UNSAFE.objectFieldOffset(f2);
        ...
        private static long checkMatrix3d() throws NoSuchFieldException, SecurityException {
            ...
            for (int i2 = 1; i2 < 9; ++i2) {
                int c2 = i2 / 3;
                int r = i2 % 3;
                f2 = (class$5 == null ? MemUtilUnsafe.class$("org.joml.Matrix3d") : class$5).getDeclaredField("m" + c2 + r);
                long offset = UNSAFE.objectFieldOffset(f2);
        ...
        private static long checkMatrix3x2f() throws NoSuchFieldException, SecurityException {
            ...
            for (int i2 = 1; i2 < 6; ++i2) {
                int c2 = i2 / 2;
                int r = i2 % 2;
                f2 = (class$6 == null ? MemUtilUnsafe.class$("org.joml.Matrix3x2f") : class$6).getDeclaredField("m" + c2 + r);
                long offset = UNSAFE.objectFieldOffset(f2);
        ...
        private static long checkMatrix2f() throws NoSuchFieldException, SecurityException {
            ...
            for (int i2 = 1; i2 < 4; ++i2) {
                int c2 = i2 / 2;
                int r = i2 % 2;
                f2 = (class$7 == null ? MemUtilUnsafe.class$("org.joml.Matrix2f") : class$7).getDeclaredField("m" + c2 + r);
                long offset = UNSAFE.objectFieldOffset(f2);
        ...
        public static void put4x3(Matrix4f m2, long destAddr) {
            ...
            for (int i2 = 0; i2 < 4; ++i2) {
                u.putLong(null, destAddr + (long)(12 * i2), u.getLong(m2, Matrix4f_m00 + (long)(i2 << 4)));
            }
            u.putFloat(null, destAddr + 8L, m2.m02());
            u.putFloat(null, destAddr + 20L, m2.m12());
            u.putFloat(null, destAddr + 32L, m2.m22());
            u.putFloat(null, destAddr + 44L, m2.m32());
        }
        ...
        public static void put4x4(Matrix4x3d m2, long destAddr) {
            Unsafe u = UNSAFE;
            u.putDouble(null, destAddr, m2.m00());
            u.putDouble(null, destAddr + 8L, m2.m01());
            u.putDouble(null, destAddr + 16L, m2.m02());
            u.putDouble(null, destAddr + 24L, 0.0);
            u.putDouble(null, destAddr + 32L, m2.m10());
            u.putDouble(null, destAddr + 40L, m2.m11());
            u.putDouble(null, destAddr + 48L, m2.m12());
            u.putDouble(null, destAddr + 56L, 0.0);
            u.putDouble(null, destAddr + 64L, m2.m20());
            u.putDouble(null, destAddr + 72L, m2.m21());
            u.putDouble(null, destAddr + 80L, m2.m22());
            u.putDouble(null, destAddr + 88L, 0.0);
            u.putDouble(null, destAddr + 96L, m2.m30());
            u.putDouble(null, destAddr + 104L, m2.m31());
            u.putDouble(null, destAddr + 112L, m2.m32());
            u.putDouble(null, destAddr + 120L, 1.0);
        }

        public static void put4x4(Matrix3x2f m2, long destAddr) {
            Unsafe u = UNSAFE;
            u.putLong(null, destAddr, u.getLong(m2, Matrix3x2f_m00));
            u.putLong(null, destAddr + 8L, 0L);
            u.putLong(null, destAddr + 16L, u.getLong(m2, Matrix3x2f_m00 + 8L));
            u.putLong(null, destAddr + 24L, 0L);
            u.putLong(null, destAddr + 32L, 0L);
            u.putLong(null, destAddr + 40L, 1065353216L);
            u.putLong(null, destAddr + 48L, u.getLong(m2, Matrix3x2f_m00 + 16L));
        ...
        public static void put4x4(Matrix3x2d m2, long destAddr) {
            ...
            u.putDouble(null, destAddr + 88L, 0.0);
            u.putDouble(null, destAddr + 96L, m2.m20());
            u.putDouble(null, destAddr + 104L, m2.m21());
        ...
        public static void put3x3(Matrix3x2f m2, long destAddr) {
            ...
            u.putLong(null, destAddr + 12L, u.getLong(m2, Matrix3x2f_m00 + 8L));
            u.putInt(null, destAddr + 20L, 0);
            u.putLong(null, destAddr + 24L, u.getLong(m2, Matrix3x2f_m00 + 16L));
        ...
        public static void put3x3(Matrix3x2d m2, long destAddr) {
            ...
            u.putDouble(null, destAddr + 8L, m2.m01());
            u.putDouble(null, destAddr + 16L, 0.0);
            u.putDouble(null, destAddr + 24L, m2.m10());
            u.putDouble(null, destAddr + 32L, m2.m11());
            u.putDouble(null, destAddr + 40L, 0.0);
            u.putDouble(null, destAddr + 48L, m2.m20());
            u.putDouble(null, destAddr + 56L, m2.m21());
            u.putDouble(null, destAddr + 64L, 1.0);
        }

        public static void putTransposed(Matrix4f m2, long destAddr) {
            Unsafe u = UNSAFE;
            u.putFloat(null, destAddr, m2.m00());
            u.putFloat(null, destAddr + 4L, m2.m10());
            u.putFloat(null, destAddr + 8L, m2.m20());
            u.putFloat(null, destAddr + 12L, m2.m30());
            u.putFloat(null, destAddr + 16L, m2.m01());
            u.putFloat(null, destAddr + 20L, m2.m11());
            u.putFloat(null, destAddr + 24L, m2.m21());
            u.putFloat(null, destAddr + 28L, m2.m31());
            u.putFloat(null, destAddr + 32L, m2.m02());
            u.putFloat(null, destAddr + 36L, m2.m12());
            u.putFloat(null, destAddr + 40L, m2.m22());
            u.putFloat(null, destAddr + 44L, m2.m32());
            u.putFloat(null, destAddr + 48L, m2.m03());
            u.putFloat(null, destAddr + 52L, m2.m13());
            u.putFloat(null, destAddr + 56L, m2.m23());
            u.putFloat(null, destAddr + 60L, m2.m33());
        }
        ...
        public static void putTransposed(Matrix3f m2, long destAddr) {
            ...
            u.putFloat(null, destAddr + 4L, m2.m10());
            u.putFloat(null, destAddr + 8L, m2.m20());
            u.putFloat(null, destAddr + 12L, m2.m01());
            u.putFloat(null, destAddr + 16L, m2.m11());
            u.putFloat(null, destAddr + 20L, m2.m21());
            u.putFloat(null, destAddr + 24L, m2.m02());
            u.putFloat(null, destAddr + 28L, m2.m12());
            u.putFloat(null, destAddr + 32L, m2.m22());
        }
        ...
        public static void put(Matrix4d m2, long destAddr) {
            ...
            u.putDouble(null, destAddr + 8L, m2.m01());
            u.putDouble(null, destAddr + 16L, m2.m02());
            u.putDouble(null, destAddr + 24L, m2.m03());
            u.putDouble(null, destAddr + 32L, m2.m10());
            u.putDouble(null, destAddr + 40L, m2.m11());
            u.putDouble(null, destAddr + 48L, m2.m12());
            u.putDouble(null, destAddr + 56L, m2.m13());
            u.putDouble(null, destAddr + 64L, m2.m20());
            u.putDouble(null, destAddr + 72L, m2.m21());
            u.putDouble(null, destAddr + 80L, m2.m22());
            u.putDouble(null, destAddr + 88L, m2.m23());
            u.putDouble(null, destAddr + 96L, m2.m30());
            u.putDouble(null, destAddr + 104L, m2.m31());
            u.putDouble(null, destAddr + 112L, m2.m32());
            u.putDouble(null, destAddr + 120L, m2.m33());
        }
        ...
        public static void put(Matrix4x3d m2, long destAddr) {
            ...
            u.putDouble(null, destAddr + 24L, m2.m10());
            u.putDouble(null, destAddr + 32L, m2.m11());
            u.putDouble(null, destAddr + 40L, m2.m12());
            u.putDouble(null, destAddr + 48L, m2.m20());
            u.putDouble(null, destAddr + 56L, m2.m21());
            u.putDouble(null, destAddr + 64L, m2.m22());
            u.putDouble(null, destAddr + 72L, m2.m30());
            u.putDouble(null, destAddr + 80L, m2.m31());
            u.putDouble(null, destAddr + 88L, m2.m32());
        }

        public static void putTransposed(Matrix4d m2, long destAddr) {
            Unsafe u = UNSAFE;
            u.putDouble(null, destAddr, m2.m00());
            u.putDouble(null, destAddr + 8L, m2.m10());
            u.putDouble(null, destAddr + 16L, m2.m20());
            u.putDouble(null, destAddr + 24L, m2.m30());
            u.putDouble(null, destAddr + 32L, m2.m01());
            u.putDouble(null, destAddr + 40L, m2.m11());
            u.putDouble(null, destAddr + 48L, m2.m21());
            u.putDouble(null, destAddr + 56L, m2.m31());
            u.putDouble(null, destAddr + 64L, m2.m02());
            u.putDouble(null, destAddr + 72L, m2.m12());
            u.putDouble(null, destAddr + 80L, m2.m22());
            u.putDouble(null, destAddr + 88L, m2.m32());
            u.putDouble(null, destAddr + 96L, m2.m03());
            u.putDouble(null, destAddr + 104L, m2.m13());
            u.putDouble(null, destAddr + 112L, m2.m23());
            u.putDouble(null, destAddr + 120L, m2.m33());
        }

        public static void putfTransposed(Matrix4d m2, long destAddr) {
            Unsafe u = UNSAFE;
            u.putFloat(null, destAddr, (float)m2.m00());
            u.putFloat(null, destAddr + 4L, (float)m2.m10());
            u.putFloat(null, destAddr + 8L, (float)m2.m20());
            u.putFloat(null, destAddr + 12L, (float)m2.m30());
            u.putFloat(null, destAddr + 16L, (float)m2.m01());
            u.putFloat(null, destAddr + 20L, (float)m2.m11());
            u.putFloat(null, destAddr + 24L, (float)m2.m21());
            u.putFloat(null, destAddr + 28L, (float)m2.m31());
            u.putFloat(null, destAddr + 32L, (float)m2.m02());
            u.putFloat(null, destAddr + 36L, (float)m2.m12());
            u.putFloat(null, destAddr + 40L, (float)m2.m22());
            u.putFloat(null, destAddr + 44L, (float)m2.m32());
            u.putFloat(null, destAddr + 48L, (float)m2.m03());
            u.putFloat(null, destAddr + 52L, (float)m2.m13());
            u.putFloat(null, destAddr + 56L, (float)m2.m23());
            u.putFloat(null, destAddr + 60L, (float)m2.m33());
        }
        ...
        public static void putf(Matrix4d m2, long destAddr) {
            Unsafe u = UNSAFE;
            u.putFloat(null, destAddr, (float)m2.m00());
            u.putFloat(null, destAddr + 4L, (float)m2.m01());
            u.putFloat(null, destAddr + 8L, (float)m2.m02());
            u.putFloat(null, destAddr + 12L, (float)m2.m03());
            u.putFloat(null, destAddr + 16L, (float)m2.m10());
            u.putFloat(null, destAddr + 20L, (float)m2.m11());
            u.putFloat(null, destAddr + 24L, (float)m2.m12());
            u.putFloat(null, destAddr + 28L, (float)m2.m13());
            u.putFloat(null, destAddr + 32L, (float)m2.m20());
            u.putFloat(null, destAddr + 36L, (float)m2.m21());
            u.putFloat(null, destAddr + 40L, (float)m2.m22());
            u.putFloat(null, destAddr + 44L, (float)m2.m23());
            u.putFloat(null, destAddr + 48L, (float)m2.m30());
            u.putFloat(null, destAddr + 52L, (float)m2.m31());
            u.putFloat(null, destAddr + 56L, (float)m2.m32());
            u.putFloat(null, destAddr + 60L, (float)m2.m33());
        }
        ...
        public static void putf(Matrix4x3d m2, long destAddr) {
            ...
            u.putFloat(null, destAddr + 4L, (float)m2.m01());
            u.putFloat(null, destAddr + 8L, (float)m2.m02());
            u.putFloat(null, destAddr + 12L, (float)m2.m10());
            u.putFloat(null, destAddr + 16L, (float)m2.m11());
            u.putFloat(null, destAddr + 20L, (float)m2.m12());
            u.putFloat(null, destAddr + 24L, (float)m2.m20());
            u.putFloat(null, destAddr + 28L, (float)m2.m21());
            u.putFloat(null, destAddr + 32L, (float)m2.m22());
            u.putFloat(null, destAddr + 36L, (float)m2.m30());
            u.putFloat(null, destAddr + 40L, (float)m2.m31());
            u.putFloat(null, destAddr + 44L, (float)m2.m32());
        }
        ...
        public static void put(Matrix3x2d m2, long destAddr) {
            ...
            u.putDouble(null, destAddr, m2.m00());
            u.putDouble(null, destAddr + 8L, m2.m01());
            u.putDouble(null, destAddr + 16L, m2.m10());
            u.putDouble(null, destAddr + 24L, m2.m11());
            u.putDouble(null, destAddr + 32L, m2.m20());
            u.putDouble(null, destAddr + 40L, m2.m21());
        }
        ...
        public static void get(Matrix4d m2, long srcAddr) {
            Unsafe u = UNSAFE;
            m2._m00(u.getDouble(null, srcAddr))._m01(u.getDouble(null, srcAddr + 8L))._m02(u.getDouble(null, srcAddr + 16L))._m03(u.getDouble(null, srcAddr + 24L))._m10(u.getDouble(null, srcAddr + 32L))._m11(u.getDouble(null, srcAddr + 40L))._m12(u.getDouble(null, srcAddr + 48L))._m13(u.getDouble(null, srcAddr + 56L))._m20(u.getDouble(null, srcAddr + 64L))._m21(u.getDouble(null, srcAddr + 72L))._m22(u.getDouble(null, srcAddr + 80L))._m23(u.getDouble(null, srcAddr + 88L))._m30(u.getDouble(null, srcAddr + 96L))._m31(u.getDouble(null, srcAddr + 104L))._m32(u.getDouble(null, srcAddr + 112L))._m33(u.getDouble(null, srcAddr + 120L));
        }

        public static void get(Matrix4x3d m2, long srcAddr) {
            Unsafe u = UNSAFE;
            m2._m00(u.getDouble(null, srcAddr))._m01(u.getDouble(null, srcAddr + 8L))._m02(u.getDouble(null, srcAddr + 16L))._m10(u.getDouble(null, srcAddr + 24L))._m11(u.getDouble(null, srcAddr + 32L))._m12(u.getDouble(null, srcAddr + 40L))._m20(u.getDouble(null, srcAddr + 48L))._m21(u.getDouble(null, srcAddr + 56L))._m22(u.getDouble(null, srcAddr + 64L))._m30(u.getDouble(null, srcAddr + 72L))._m31(u.getDouble(null, srcAddr + 80L))._m32(u.getDouble(null, srcAddr + 88L));
        }

        public static void getf(Matrix4d m2, long srcAddr) {
            Unsafe u = UNSAFE;
            m2._m00(u.getFloat(null, srcAddr))._m01(u.getFloat(null, srcAddr + 4L))._m02(u.getFloat(null, srcAddr + 8L))._m03(u.getFloat(null, srcAddr + 12L))._m10(u.getFloat(null, srcAddr + 16L))._m11(u.getFloat(null, srcAddr + 20L))._m12(u.getFloat(null, srcAddr + 24L))._m13(u.getFloat(null, srcAddr + 28L))._m20(u.getFloat(null, srcAddr + 32L))._m21(u.getFloat(null, srcAddr + 36L))._m22(u.getFloat(null, srcAddr + 40L))._m23(u.getFloat(null, srcAddr + 44L))._m30(u.getFloat(null, srcAddr + 48L))._m31(u.getFloat(null, srcAddr + 52L))._m32(u.getFloat(null, srcAddr + 56L))._m33(u.getFloat(null, srcAddr + 60L));
        }

        public static void getf(Matrix4x3d m2, long srcAddr) {
            Unsafe u = UNSAFE;
            m2._m00(u.getFloat(null, srcAddr))._m01(u.getFloat(null, srcAddr + 4L))._m02(u.getFloat(null, srcAddr + 8L))._m10(u.getFloat(null, srcAddr + 12L))._m11(u.getFloat(null, srcAddr + 16L))._m12(u.getFloat(null, srcAddr + 20L))._m20(u.getFloat(null, srcAddr + 24L))._m21(u.getFloat(null, srcAddr + 28L))._m22(u.getFloat(null, srcAddr + 32L))._m30(u.getFloat(null, srcAddr + 36L))._m31(u.getFloat(null, srcAddr + 40L))._m32(u.getFloat(null, srcAddr + 44L));
        }
        ...
        public static void get(Matrix3d m2, long srcAddr) {
            Unsafe u = UNSAFE;
            m2._m00(u.getDouble(null, srcAddr))._m01(u.getDouble(null, srcAddr + 8L))._m02(u.getDouble(null, srcAddr + 16L))._m10(u.getDouble(null, srcAddr + 24L))._m11(u.getDouble(null, srcAddr + 32L))._m12(u.getDouble(null, srcAddr + 40L))._m20(u.getDouble(null, srcAddr + 48L))._m21(u.getDouble(null, srcAddr + 56L))._m22(u.getDouble(null, srcAddr + 64L));
        }
        ...
        public static void get(Matrix3x2d m2, long srcAddr) {
            Unsafe u = UNSAFE;
            m2._m00(u.getDouble(null, srcAddr))._m01(u.getDouble(null, srcAddr + 8L))._m10(u.getDouble(null, srcAddr + 16L))._m11(u.getDouble(null, srcAddr + 24L))._m20(u.getDouble(null, srcAddr + 32L))._m21(u.getDouble(null, srcAddr + 40L));
        }

        public static void getf(Matrix3d m2, long srcAddr) {
            Unsafe u = UNSAFE;
            m2._m00(u.getFloat(null, srcAddr))._m01(u.getFloat(null, srcAddr + 4L))._m02(u.getFloat(null, srcAddr + 8L))._m10(u.getFloat(null, srcAddr + 12L))._m11(u.getFloat(null, srcAddr + 16L))._m12(u.getFloat(null, srcAddr + 20L))._m20(u.getFloat(null, srcAddr + 24L))._m21(u.getFloat(null, srcAddr + 28L))._m22(u.getFloat(null, srcAddr + 32L));
        }
        ...
        public float get(Matrix3f m2, int column, int row) {
            return UNSAFE.getFloat(m2, Matrix3f_m00 + (long)(column * 12) + (long)(row << 2));
        }

        public Matrix3f set(Matrix3f m2, int column, int row, float value) {
            UNSAFE.putFloat(m2, Matrix3f_m00 + (long)(column * 12) + (long)(row << 2), value);
            return m2;
        }

        public double get(Matrix3d m2, int column, int row) {
            return UNSAFE.getDouble(m2, Matrix3d_m00 + (long)(column * 24) + (long)(row << 3));
        }

        public Matrix3d set(Matrix3d m2, int column, int row, double value) {
            UNSAFE.putDouble(m2, Matrix3d_m00 + (long)(column * 24) + (long)(row << 3), value);
            return m2;
        }
