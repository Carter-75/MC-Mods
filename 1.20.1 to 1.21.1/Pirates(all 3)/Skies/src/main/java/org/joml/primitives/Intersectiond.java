...
public class Intersectiond {
    ...
    public static boolean testPlaneSphere(Planed plane, Spheref sphere) {
        return Intersectiond.testPlaneSphere(plane.a, plane.b, plane.c, plane.d, sphere.x, sphere.y, sphere.z, sphere.r);
    }
    ...
    public static boolean testAabPlane(AABBd aabb, Planed plane) {
        return Intersectiond.testAabPlane(aabb.minX, aabb.minY, aabb.minZ, aabb.maxX, aabb.maxY, aabb.maxZ, plane.a, plane.b, plane.c, plane.d);
    }
    ...
    public static boolean testAabAab(AABBd aabb1, AABBd aabb2) {
        return Intersectiond.testAabAab(aabb1.minX, aabb1.minY, aabb1.minZ, aabb1.maxX, aabb1.maxY, aabb1.maxZ, aabb2.minX, aabb2.minY, aabb2.minZ, aabb2.maxX, aabb2.maxY, aabb2.maxZ);
    }
    ...
    public static boolean intersectSphereSphere(Spheref sphereA, Spheref sphereB, Vector4d centerAndRadiusOfIntersectionCircle) {
        return Intersectiond.intersectSphereSphere(sphereA.x, sphereA.y, sphereA.z, sphereA.r * sphereA.r, sphereB.x, sphereB.y, sphereB.z, sphereB.r * sphereB.r, centerAndRadiusOfIntersectionCircle);
    }
    ...
    public static double intersectRayPlane(Rayd ray, Planed plane, double epsilon) {
        return Intersectiond.intersectRayPlane(ray.oX, ray.oY, ray.oZ, ray.dX, ray.dY, ray.dZ, plane.a, plane.b, plane.c, plane.d, epsilon);
    }
    ...
    public static boolean testAabSphere(AABBd aabb, Spheref sphere) {
        return Intersectiond.testAabSphere(aabb.minX, aabb.minY, aabb.minZ, aabb.maxX, aabb.maxY, aabb.maxZ, sphere.x, sphere.y, sphere.z, sphere.r * sphere.r);
    }
    ...
    public static boolean intersectRaySphere(Rayd ray, Spheref sphere, Vector2d result2) {
        return Intersectiond.intersectRaySphere(ray.oX, ray.oY, ray.oZ, ray.dX, ray.dY, ray.dZ, sphere.x, sphere.y, sphere.z, sphere.r * sphere.r, result2);
    }
    ...
    public static boolean testRaySphere(Rayd ray, Spheref sphere) {
        return Intersectiond.testRaySphere(ray.oX, ray.oY, ray.oZ, ray.dX, ray.dY, ray.dZ, sphere.x, sphere.y, sphere.z, sphere.r * sphere.r);
    }
    ...
    public static boolean intersectRayAab(Rayd ray, AABBd aabb, Vector2d result2) {
        return Intersectiond.intersectRayAab(ray.oX, ray.oY, ray.oZ, ray.dX, ray.dY, ray.dZ, aabb.minX, aabb.minY, aabb.minZ, aabb.maxX, aabb.maxY, aabb.maxZ, result2);
    }
    ...
    public static int intersectLineSegmentAab(LineSegmentf lineSegment, AABBd aabb, Vector2d result2) {
        return Intersectiond.intersectLineSegmentAab(lineSegment.aX, lineSegment.aY, lineSegment.aZ, lineSegment.bX, lineSegment.bY, lineSegment.bZ, aabb.minX, aabb.minY, aabb.minZ, aabb.maxX, aabb.maxY, aabb.maxZ, result2);
    }
    ...
    public static boolean testRayAab(Rayd ray, AABBd aabb) {
        return Intersectiond.testRayAab(ray.oX, ray.oY, ray.oZ, ray.dX, ray.dY, ray.dZ, aabb.minX, aabb.minY, aabb.minZ, aabb.maxX, aabb.maxY, aabb.maxZ);
    }
