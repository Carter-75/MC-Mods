...
Matrix4fc {
    ...
    public Matrix4f set(AxisAngle4f axisAngle) {
        ...
        double n2 = Math.sqrt(x * x + y * y + z * z);
        n2 = 1.0 / n2;
        x = (float)((double)x * n2);
        y = (float)((double)y * n2);
        z = (float)((double)z * n2);
        float s = Math.sin(angle);
        float c2 = Math.cosFromSin(s, angle);
        float omc = 1.0f - c2;
        this._m00(c2 + x * x * omc)._m11(c2 + y * y * omc)._m22(c2 + z * z * omc);
        float tmp1 = x * y * omc;
        float tmp2 = z * s;
    ...
    public Matrix4f set(AxisAngle4d axisAngle) {
        ...
        double c2 = Math.cosFromSin(s, angle);
        double omc = 1.0 - c2;
        this._m00((float)(c2 + (x *= n2) * x * omc))._m11((float)(c2 + (y *= n2) * y * omc))._m22((float)(c2 + (z *= n2) * z * omc));
        double tmp1 = x * y * omc;
        double tmp2 = z * s;
    ...
    private Matrix4f rotationInternal(float angle, float x, float y, float z) {
        ...
        return this._m00(cos + x * x * C2)._m10(xy * C2 - z * sin)._m20(xz * C2 + y * sin)._m01(xy * C2 + z * sin)._m11(cos + y * y * C2)._m21(yz * C2 - x * sin)._m02(xz * C2 - y * sin)._m12(yz * C2 + x * sin)._m22(cos + z * z * C2)._properties(18);
    }
    ...
    public Matrix4f translationRotateScaleMulAffine(float tx, float ty, float tz, float qx, float qy, float qz, float qw, float sx, float sy, float sz, Matrix4f m2) {
        float w2 = qw * qw;
        float x2 = qx * qx;
        float y2 = qy * qy;
        float z2 = qz * qz;
    ...
    private Matrix4f rotateGenericInternal(float ang, float x, float y, float z, Matrix4f dest) {
        ...
        float c2 = Math.cosFromSin(s, ang);
        float C2 = 1.0f - c2;
        float xx = x * x;
        float xy = x * y;
        float xz = x * z;
        ...
        float zz = z * z;
        float rm00 = xx * C2 + c2;
        float rm01 = xy * C2 + z * s;
        float rm02 = xz * C2 - y * s;
        float rm10 = xy * C2 - z * s;
        float rm11 = yy * C2 + c2;
        float rm12 = yz * C2 + x * s;
        float rm20 = xz * C2 + y * s;
        float rm21 = yz * C2 - x * s;
        float rm22 = zz * C2 + c2;
    ...
    private Matrix4f rotateLocalGenericInternal(float ang, float x, float y, float z, Matrix4f dest) {
        ...
        float zz = z * z;
        float lm00 = xx * C2 + c2;
        float lm01 = xy * C2 + z * s;
        float lm02 = xz * C2 - y * s;
        float lm10 = xy * C2 - z * s;
        float lm11 = yy * C2 + c2;
        float lm12 = yz * C2 + x * s;
        float lm20 = xz * C2 + y * s;
        float lm21 = yz * C2 - x * s;
        float lm22 = zz * C2 + c2;
    ...
    public Matrix4f tile(int x, int y, int w, int h2) {
        return this.tile(x, y, w, h2, this);
    }

    public Matrix4f tile(int x, int y, int w, int h2, Matrix4f dest) {
        float tx = w - 1 - (x << 1);
        float ty = h2 - 1 - (y << 1);
        return dest._m30(Math.fma(this.m00(), tx, Math.fma(this.m10(), ty, this.m30())))._m31(Math.fma(this.m01(), tx, Math.fma(this.m11(), ty, this.m31())))._m32(Math.fma(this.m02(), tx, Math.fma(this.m12(), ty, this.m32())))._m33(Math.fma(this.m03(), tx, Math.fma(this.m13(), ty, this.m33())))._m00(this.m00() * (float)w)._m01(this.m01() * (float)w)._m02(this.m02() * (float)w)._m03(this.m03() * (float)w)._m10(this.m10() * (float)h2)._m11(this.m11() * (float)h2)._m12(this.m12() * (float)h2)._m13(this.m13() * (float)h2)._m20(this.m20())._m21(this.m21())._m22(this.m22())._m23(this.m23())._properties(this.properties & 0xFFFFFFE2);
    }
    ...
    private Matrix4f reflectAffine(float a2, float b2, float c2, float d2, Matrix4f dest) {
        ...
        float dc = c2 + c2;
        float dd = d2 + d2;
        float rm00 = 1.0f - da * a2;
        float rm01 = -da * b2;
        float rm02 = -da * c2;
        float rm10 = -db * a2;
        float rm11 = 1.0f - db * b2;
        float rm12 = -db * c2;
        float rm20 = -dc * a2;
        float rm21 = -dc * b2;
        float rm22 = 1.0f - dc * c2;
        float rm30 = -dd * a2;
        float rm31 = -dd * b2;
        float rm32 = -dd * c2;
    ...
    public Matrix4f reflection(float a2, float b2, float c2, float d2) {
        ...
        float dc = c2 + c2;
        float dd = d2 + d2;
        this._m00(1.0f - da * a2)._m01(-da * b2)._m02(-da * c2)._m03(0.0f)._m10(-db * a2)._m11(1.0f - db * b2)._m12(-db * c2)._m13(0.0f)._m20(-dc * a2)._m21(-dc * b2)._m22(1.0f - dc * c2)._m23(0.0f)._m30(-dd * a2)._m31(-dd * b2)._m32(-dd * c2)._m33(1.0f)._properties(18);
        return this;
    }
    ...
    public Vector3f frustumRayDir(float x, float y, Vector3f dir) {
        ...
        float m1x = (d2 + e2 + f2 - a2 - b2 - c2) * (1.0f - y) + (a2 - b2 - c2 + d2 - e2 + f2) * y;
        float m1y = (j2 + k2 + l2 - g2 - h2 - i2) * (1.0f - y) + (g2 - h2 - i2 + j2 - k2 + l2) * y;
        float m1z = (p + q + r - m2 - n2 - o) * (1.0f - y) + (m2 - n2 - o + p - q + r) * y;
        float m2x = (b2 - c2 - d2 + e2 + f2 - a2) * (1.0f - y) + (a2 + b2 - c2 - d2 - e2 + f2) * y;
        float m2y = (h2 - i2 - j2 + k2 + l2 - g2) * (1.0f - y) + (g2 + h2 - i2 - j2 - k2 + l2) * y;
        float m2z = (n2 - o - p + q + r - m2) * (1.0f - y) + (m2 + n2 - o - p - q + r) * y;
        dir.x = m1x + (m2x - m1x) * x;
        dir.y = m1y + (m2y - m1y) * x;
        dir.z = m1z + (m2z - m1z) * x;
    ...
    public Matrix4f shadow(float lightX, float lightY, float lightZ, float lightW, float a2, float b2, float c2, float d2, Matrix4f dest) {
        ...
        float an = a2 * invPlaneLen;
        float bn = b2 * invPlaneLen;
        float cn = c2 * invPlaneLen;
        float dn = d2 * invPlaneLen;
    ...
    public int hashCode() {
        int prime = 31;
        int result2 = 1;
        result2 = 31 * result2 + Float.floatToIntBits(this.m00());
        result2 = 31 * result2 + Float.floatToIntBits(this.m01());
        result2 = 31 * result2 + Float.floatToIntBits(this.m02());
        result2 = 31 * result2 + Float.floatToIntBits(this.m03());
        result2 = 31 * result2 + Float.floatToIntBits(this.m10());
        result2 = 31 * result2 + Float.floatToIntBits(this.m11());
        result2 = 31 * result2 + Float.floatToIntBits(this.m12());
        result2 = 31 * result2 + Float.floatToIntBits(this.m13());
        result2 = 31 * result2 + Float.floatToIntBits(this.m20());
        result2 = 31 * result2 + Float.floatToIntBits(this.m21());
        result2 = 31 * result2 + Float.floatToIntBits(this.m22());
        result2 = 31 * result2 + Float.floatToIntBits(this.m23());
        result2 = 31 * result2 + Float.floatToIntBits(this.m30());
        result2 = 31 * result2 + Float.floatToIntBits(this.m31());
        result2 = 31 * result2 + Float.floatToIntBits(this.m32());
        result2 = 31 * result2 + Float.floatToIntBits(this.m33());
        return result2;
    }
    ...
    public Matrix4f affineSpan(Vector3f corner, Vector3f xDir, Vector3f yDir, Vector3f zDir) {
        ...
        float nm21 = (n2 - p) * s;
        float nm22 = (h2 - d2) * s;
        corner.x = -nm00 - nm10 - nm20 + (a2 * this.m31() - b2 * this.m32() + f2 * this.m32() - e2 * this.m30() + i2 * this.m30() - j2 * this.m31()) * s;
        corner.y = -nm01 - nm11 - nm21 + (m2 * this.m31() - n2 * this.m32() + p * this.m32() - o * this.m30() + q * this.m30() - r * this.m31()) * s;
        corner.z = -nm02 - nm12 - nm22 + (g2 * this.m30() - k2 * this.m30() + l2 * this.m31() - c2 * this.m31() + d2 * this.m32() - h2 * this.m32()) * s;
        xDir.x = 2.0f * nm00;
        xDir.y = 2.0f * nm01;
        xDir.z = 2.0f * nm02;
        yDir.x = 2.0f * nm10;
    ...
    public Matrix4f withLookAtUp(float upX, float upY, float upZ, Matrix4f dest) {
        ...
        float c2 = x * invsqrt;
        float s = y * invsqrt;
        float nm00 = c2 * this.m00() - s * this.m01();
        float nm10 = c2 * this.m10() - s * this.m11();
        float nm20 = c2 * this.m20() - s * this.m21();
        float nm31 = s * this.m30() + c2 * this.m31();
        float nm01 = s * this.m00() + c2 * this.m01();
        float nm11 = s * this.m10() + c2 * this.m11();
        float nm21 = s * this.m20() + c2 * this.m21();
        float nm30 = c2 * this.m30() - s * this.m31();
