...
Matrix2dc {
    ...
    public Matrix2d rotate(double angle, Matrix2d dest) {
        ...
        double nm00 = this.m00 * c2 + this.m10 * s;
        double nm01 = this.m01 * c2 + this.m11 * s;
        double nm10 = this.m10 * c2 - this.m00 * s;
        double nm11 = this.m11 * c2 - this.m01 * s;
        dest.m00 = nm00;
        dest.m01 = nm01;
        dest.m10 = nm10;
        dest.m11 = nm11;
    ...
    public int hashCode() {
        ...
        result2 = 31 * result2 + (int)(temp >>> 32 ^ temp);
