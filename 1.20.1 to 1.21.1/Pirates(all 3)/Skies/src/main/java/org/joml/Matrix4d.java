...
Matrix4dc {
    ...
    public Matrix4d set(AxisAngle4f axisAngle) {
        ...
        double omc = 1.0 - c2;
        this._m00(c2 + (x *= invLength) * x * omc)._m11(c2 + (y *= invLength) * y * omc)._m22(c2 + (z *= invLength) * z * omc);
        double tmp1 = x * y * omc;
        double tmp2 = z * s;
    ...
    private Matrix4d rotationInternal(double angle, double x, double y, double z) {
        ...
        this._m00((double)(cos + x * x * C2))._m10((double)(xy * C2 - z * sin))._m20((double)(xz * C2 + y * sin))._m01((double)(xy * C2 + z * sin))._m11((double)(cos + y * y * C2))._m21((double)(yz * C2 - x * sin))._m02((double)(xz * C2 - y * sin))._m12((double)(yz * C2 + x * sin))._m22((double)(cos + z * z * C2)).properties = 18;
        return this;
    }
    ...
    private Matrix4d rotateGenericInternal(double ang, double x, double y, double z, Matrix4d dest) {
        ...
        double c2 = Math.cosFromSin(s, ang);
        double C2 = 1.0 - c2;
        double xx = x * x;
        double xy = x * y;
        double xz = x * z;
        ...
        double yz = y * z;
        double zz = z * z;
        double rm00 = xx * C2 + c2;
        double rm01 = xy * C2 + z * s;
        double rm02 = xz * C2 - y * s;
        double rm10 = xy * C2 - z * s;
        double rm11 = yy * C2 + c2;
        double rm12 = yz * C2 + x * s;
        double rm20 = xz * C2 + y * s;
        double rm21 = yz * C2 - x * s;
        double rm22 = zz * C2 + c2;
    ...
    private Matrix4d rotateLocalGenericInternal(double ang, double x, double y, double z, Matrix4d dest) {
        ...
        double yz = y * z;
        double zz = z * z;
        double lm00 = xx * C2 + c2;
        double lm01 = xy * C2 + z * s;
        double lm02 = xz * C2 - y * s;
        double lm10 = xy * C2 - z * s;
        double lm11 = yy * C2 + c2;
        double lm12 = yz * C2 + x * s;
        double lm20 = xz * C2 + y * s;
        double lm21 = yz * C2 - x * s;
        double lm22 = zz * C2 + c2;
    ...
    public Matrix4d translationRotateScaleMulAffine(double tx, double ty, double tz, double qx, double qy, double qz, double qw, double sx, double sy, double sz, Matrix4d m2) {
        double w2 = qw * qw;
        double x2 = qx * qx;
        double y2 = qy * qy;
        double z2 = qz * qz;
    ...
    private Matrix4d reflectAffine(double a2, double b2, double c2, double d2, Matrix4d dest) {
        ...
        double dc = c2 + c2;
        double dd = d2 + d2;
        double rm00 = 1.0 - da * a2;
        double rm01 = -da * b2;
        double rm02 = -da * c2;
        double rm10 = -db * a2;
        double rm11 = 1.0 - db * b2;
        double rm12 = -db * c2;
        double rm20 = -dc * a2;
        double rm21 = -dc * b2;
        double rm22 = 1.0 - dc * c2;
        double rm30 = -dd * a2;
        double rm31 = -dd * b2;
        double rm32 = -dd * c2;
        double nm00 = this.m00 * rm00 + this.m10 * rm01 + this.m20 * rm02;
    ...
    public Matrix4d reflection(double a2, double b2, double c2, double d2) {
        ...
        double dc = c2 + c2;
        double dd = d2 + d2;
        this._m00((double)(1.0 - da * a2))._m01((double)(-da * b2))._m02((double)(-da * c2))._m03((double)0.0)._m10((double)(-db * a2))._m11((double)(1.0 - db * b2))._m12((double)(-db * c2))._m13((double)0.0)._m20((double)(-dc * a2))._m21((double)(-dc * b2))._m22((double)(1.0 - dc * c2))._m23((double)0.0)._m30((double)(-dd * a2))._m31((double)(-dd * b2))._m32((double)(-dd * c2))._m33((double)1.0).properties = 18;
        return this;
    }
    ...
    public Matrix4d tile(int x, int y, int w, int h2) {
        return this.tile(x, y, w, h2, this);
    }

    public Matrix4d tile(int x, int y, int w, int h2, Matrix4d dest) {
        float tx = w - 1 - (x << 1);
        float ty = h2 - 1 - (y << 1);
        return dest._m30(Math.fma(this.m00, (double)tx, Math.fma(this.m10, (double)ty, this.m30)))._m31(Math.fma(this.m01, (double)tx, Math.fma(this.m11, (double)ty, this.m31)))._m32(Math.fma(this.m02, (double)tx, Math.fma(this.m12, (double)ty, this.m32)))._m33(Math.fma(this.m03, (double)tx, Math.fma(this.m13, (double)ty, this.m33)))._m00(this.m00 * (double)w)._m01(this.m01 * (double)w)._m02(this.m02 * (double)w)._m03(this.m03 * (double)w)._m10(this.m10 * (double)h2)._m11(this.m11 * (double)h2)._m12(this.m12 * (double)h2)._m13(this.m13 * (double)h2)._m20(this.m20)._m21(this.m21)._m22(this.m22)._m23(this.m23)._properties(this.properties & 0xFFFFFFE2);
    }
    ...
    public Vector3d frustumRayDir(double x, double y, Vector3d dest) {
        ...
        double m1x = (d2 + e2 + f2 - a2 - b2 - c2) * (1.0 - y) + (a2 - b2 - c2 + d2 - e2 + f2) * y;
        double m1y = (j2 + k2 + l2 - g2 - h2 - i2) * (1.0 - y) + (g2 - h2 - i2 + j2 - k2 + l2) * y;
        double m1z = (p + q + r - m2 - n2 - o) * (1.0 - y) + (m2 - n2 - o + p - q + r) * y;
        double m2x = (b2 - c2 - d2 + e2 + f2 - a2) * (1.0 - y) + (a2 + b2 - c2 - d2 - e2 + f2) * y;
        double m2y = (h2 - i2 - j2 + k2 + l2 - g2) * (1.0 - y) + (g2 + h2 - i2 - j2 - k2 + l2) * y;
        double m2z = (n2 - o - p + q + r - m2) * (1.0 - y) + (m2 + n2 - o - p - q + r) * y;
    ...
    public Matrix4d shadow(double lightX, double lightY, double lightZ, double lightW, double a2, double b2, double c2, double d2, Matrix4d dest) {
        ...
        double an = a2 * invPlaneLen;
        double bn = b2 * invPlaneLen;
        double cn = c2 * invPlaneLen;
        double dn = d2 * invPlaneLen;
    ...
    public Matrix4d withLookAtUp(double upX, double upY, double upZ, Matrix4d dest) {
        ...
        double c2 = x * invsqrt;
        double s = y * invsqrt;
        double nm00 = c2 * this.m00 - s * this.m01;
        double nm10 = c2 * this.m10 - s * this.m11;
        double nm20 = c2 * this.m20 - s * this.m21;
        double nm31 = s * this.m30 + c2 * this.m31;
        double nm01 = s * this.m00 + c2 * this.m01;
        double nm11 = s * this.m10 + c2 * this.m11;
        double nm21 = s * this.m20 + c2 * this.m21;
        double nm30 = c2 * this.m30 - s * this.m31;
