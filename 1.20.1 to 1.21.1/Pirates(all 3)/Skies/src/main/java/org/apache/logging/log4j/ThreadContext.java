...
public final class ThreadContext {
    ...
    public static void putAll(Map<String, String> m2) {
        if (contextMap instanceof ThreadContextMap2) {
            ((ThreadContextMap2)contextMap).putAll(m2);
        } else if (contextMap instanceof DefaultThreadContextMap) {
            ((DefaultThreadContextMap)contextMap).putAll(m2);
        } else {
    ...
    public static ContextStack getImmutableStack() {
        ContextStack result2 = contextStack.getImmutableStackOrNull();
        return result2 == null ? EMPTY_STACK : result2;
    }
