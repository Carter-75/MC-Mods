...
SynchronousBundleListener {
    ...
    private void loadProvider(Bundle bundle) {
        ...
        try {
            ...
            LOGGER.debug("Cannot access bundle [{}] contents. Ignoring.", (Object)bundle.getSymbolicName(), (Object)e2);
        }
        catch (Exception e3) {
            LOGGER.warn("Problem checking bundle {} for Log4j 2 provider.", (Object)bundle.getSymbolicName(), (Object)e3);
        }
    }
    ...
    private void loadProvider(BundleContext bundleContext, BundleWiring bundleWiring) {
        String filter2 = "(APIVersion>=2.6.0)";
        try {
