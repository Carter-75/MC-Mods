...
public class Provider {
    ...
    public Class<? extends LoggerContextFactory> loadLoggerContextFactory() {
        ...
        try {
            ...
            LOGGER.error("Unable to create class {} specified in {}", (Object)this.className, (Object)this.url.toString(), (Object)e2);
        }
        return null;
    }
    ...
    public Class<? extends ThreadContextMap> loadThreadContextMap() {
        ...
        try {
            ...
            LOGGER.error("Unable to create class {} specified in {}", (Object)this.threadContextMap, (Object)this.url.toString(), (Object)e2);
        }
        return null;
    }
    ...
    public String toString() {
        ClassLoader loader;
        StringBuilder result2 = new StringBuilder("Provider[");
        if (!DEFAULT_PRIORITY.equals(this.priority)) {
            result2.append("priority=").append(this.priority).append(", ");
        }
        if (this.threadContextMap != null) {
            result2.append("threadContextMap=").append(this.threadContextMap).append(", ");
        } else if (this.threadContextMapClass != null) {
            result2.append("threadContextMapClass=").append(this.threadContextMapClass.getName());
        }
        if (this.className != null) {
            result2.append("className=").append(this.className).append(", ");
        } else if (this.loggerContextFactoryClass != null) {
            result2.append("class=").append(this.loggerContextFactoryClass.getName());
        }
        if (this.url != null) {
            result2.append("url=").append(this.url);
        }
        if (this.classLoader == null || (loader = (ClassLoader)this.classLoader.get()) == null) {
            result2.append(", classLoader=null(not reachable)");
        } else {
            result2.append(", classLoader=").append(loader);
        }
        result2.append("]");
    ...
    public int hashCode() {
        int result2 = this.priority != null ? this.priority.hashCode() : 0;
        result2 = 31 * result2 + (this.className != null ? this.className.hashCode() : 0);
        result2 = 31 * result2 + (this.loggerContextFactoryClass != null ? this.loggerContextFactoryClass.hashCode() : 0);
        result2 = 31 * result2 + (this.versions != null ? this.versions.hashCode() : 0);
        return result2;
    }
}
