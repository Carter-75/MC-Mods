...
StringBuilderFormattable {
    ...
    public int hashCode() {
        ...
        result2 = 29 * result2 + (this.status != null ? this.status.hashCode() : 0);
        long time = this.startTime.get();
        result2 = 29 * result2 + (int)(time ^ time >>> 32);
        result2 = 29 * result2 + (int)(this.elapsedTime ^ this.elapsedTime >>> 32);
        return result2;
    }
