...
public final class MarkerManager {
    ...
    public static Marker getMarker(String name) {
        Marker result2 = (Marker)MARKERS.get(name);
        if (result2 == null) {
            MARKERS.putIfAbsent(name, new Log4jMarker(name));
            result2 = (Marker)MARKERS.get(name);
        }
        return result2;
    }
    ...
    StringBuilderFormattable {
        ...
        public synchronized Marker addParents(Marker ... parentMarkers) {
            ...
            if (localParents != null) {
                ...
                size = localParents.length + count2;
            }
        ...
        public synchronized boolean remove(Marker parent) {
            ...
            for (int i2 = 0; i2 < localParentsLength; ++i2) {
                Marker marker = localParents[i2];
        ...
        public boolean isInstanceOf(Marker marker) {
            ...
            if (localParents != null) {
                ...
                for (int i2 = 0; i2 < localParentsLength; ++i2) {
                    Marker localParent = localParents[i2];
