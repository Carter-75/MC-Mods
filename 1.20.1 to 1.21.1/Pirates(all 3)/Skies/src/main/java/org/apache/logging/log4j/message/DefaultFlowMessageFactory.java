...
Serializable {
    ...
    @Override
    public ExitMessage newExitMessage(Object result2, EntryMessage message) {
        return new SimpleExitMessage(this.exitText, result2, message);
    }

    @Override
    public ExitMessage newExitMessage(Object result2, Message message) {
        return new SimpleExitMessage(this.exitText, result2, message);
    }
    ...
    implements ExitMessage {
        ...
        SimpleExitMessage(String exitText, Object result2, EntryMessage message) {
            super(exitText, message.getMessage());
            this.result = result2;
            this.isVoid = false;
        }

        SimpleExitMessage(String exitText, Object result2, Message message) {
