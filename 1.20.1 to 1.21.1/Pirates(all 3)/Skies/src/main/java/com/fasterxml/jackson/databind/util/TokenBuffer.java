...
extends JsonGenerator {
    ...
    public static TokenBuffer asCopyOfValue(JsonParser p) throws IOException {
        TokenBuffer b2 = new TokenBuffer(p);
        ...
        while (true) {
            ...
            switch (t) {
                ...
                case VALUE_NUMBER_FLOAT: {
                    ...
                    this._reportError(String.format("Unrecognized value type for VALUE_NUMBER_FLOAT: %s, cannot serialize", n2.getClass().getName()));
                    break;
                }
                case VALUE_TRUE: {
    ...
    public String toString() {
        ...
        if (count2 >= 100) {
            sb.append(" ... (truncated ").append(count2 - 100).append(" entries)");
        }
        sb.append(']');
        return sb.toString();
    }
    ...
    private void _copyBufferValue(JsonParser p, JsonToken t) throws IOException {
        ...
        block0 : switch (t) {
            ...
            case VALUE_NUMBER_FLOAT: {
                ...
                Number n2 = p.getNumberValueExact();
                this._appendValue(JsonToken.VALUE_NUMBER_FLOAT, n2);
                break;
            }
            case VALUE_TRUE: {
                this.writeBoolean(true);
