...
public @interface JsonInclude {
    ...
    Serializable {
        ...
        public Value withValueFilter(Class<?> filter2) {
            Include incl;
            if (filter2 == null || filter2 == Void.class) {
                incl = Include.USE_DEFAULTS;
                filter2 = null;
            } else {
                incl = Include.CUSTOM;
            }
            return Value.construct(incl, this._contentInclusion, filter2, this._contentFilter);
        }

        public Value withContentFilter(Class<?> filter2) {
            Include incl;
            if (filter2 == null || filter2 == Void.class) {
                incl = Include.USE_DEFAULTS;
                filter2 = null;
            ...
            return Value.construct(this._valueInclusion, incl, this._valueFilter, filter2);
        }
