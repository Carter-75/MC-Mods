...
extends JsonParserDelegate {
    ...
    @Deprecated
    public FilteringParserDelegate(JsonParser p, TokenFilter f2, boolean includePath, boolean allowMultipleMatches) {
        this(p, f2, includePath ? TokenFilter.Inclusion.INCLUDE_ALL_AND_PATH : TokenFilter.Inclusion.ONLY_INCLUDE_ALL, allowMultipleMatches);
    }

    public FilteringParserDelegate(JsonParser p, TokenFilter f2, TokenFilter.Inclusion inclusion, boolean allowMultipleMatches) {
        super(p);
        this.rootFilter = f2;
        this._itemFilter = f2;
    ...
    public JsonToken nextToken() throws IOException {
        ...
        switch (t.id()) {
            case 3: {
                ...
                if (f2 != null && this._inclusion == TokenFilter.Inclusion.INCLUDE_NON_NULL) {
                    this._headContext = this._headContext.createChildArrayContext(f2, true);
                    this._currToken = t;
                    return this._currToken;
                }
            ...
            switch (t.id()) {
                ...
                case 4: {
                    ...
                    if (f2 != null && f2 != TokenFilter.INCLUDE_ALL) {
                        includeEmpty = f2.includeEmptyArray(this._headContext.hasCurrentIndex());
                ...
                case 2: {
                    ...
                    f2 = this._headContext.getFilter();
                    if (f2 != null && f2 != TokenFilter.INCLUDE_ALL) {
                        includeEmpty = f2.includeEmptyArray(this._headContext.hasCurrentName());
                        f2.filterFinishObject();
                        if (includeEmpty) {
                            return this._nextBuffered(this._headContext);
                        }
                    }
        ...
        block7: while (true) {
            ...
            switch (t.id()) {
                ...
                case 4: {
                    f2 = this._headContext.getFilter();
                    if (f2 != null && f2 != TokenFilter.INCLUDE_ALL) {
                        boolean includeEmpty = f2.includeEmptyArray(this._headContext.hasCurrentIndex());
                        f2.filterFinishArray();
                        if (includeEmpty) {
                            return this._nextBuffered(buffRoot);
                        }
                ...
                case 2: {
                    f2 = this._headContext.getFilter();
                    if (f2 != null && f2 != TokenFilter.INCLUDE_ALL) {
                        boolean includeEmpty = f2.includeEmptyObject(this._headContext.hasCurrentName());
                        f2.filterFinishObject();
                        if (includeEmpty) {
                ...
                case 5: {
                    ...
                    this._itemFilter = f2;
                    if (f2 != TokenFilter.INCLUDE_ALL) continue block7;
                    if (this._verifyAllowedMatches()) {
                        return this._nextBuffered(buffRoot);
                    }
