...
implements Serializable {
    ...
    protected void _throwAsIOE(JsonParser p, Exception e2, Object value) throws IOException {
        if (e2 instanceof IllegalArgumentException) {
            ...
            throw JsonMappingException.from(p, msg.toString(), (Throwable)e2);
        }
        this._throwAsIOE(p, e2);
    }

    protected IOException _throwAsIOE(JsonParser p, Exception e2) throws IOException {
        ClassUtil.throwIfIOE(e2);
        ClassUtil.throwIfRTE(e2);
        Throwable th = ClassUtil.getRootCause(e2);
