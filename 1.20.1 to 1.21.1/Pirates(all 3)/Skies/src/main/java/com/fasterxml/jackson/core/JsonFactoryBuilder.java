...
extends TSFBuilder<JsonFactory, JsonFactoryBuilder> {
    ...
    @Override
    public JsonFactoryBuilder enable(JsonReadFeature first2, JsonReadFeature ... other) {
        this._legacyEnable(first2.mappedFeature());
        this.enable(first2);
    ...
    @Override
    public JsonFactoryBuilder disable(JsonReadFeature first2, JsonReadFeature ... other) {
        this._legacyDisable(first2.mappedFeature());
        for (JsonReadFeature f2 : other) {
            this._legacyEnable(f2.mappedFeature());
        }
        return this;
    ...
    @Override
    public JsonFactoryBuilder enable(JsonWriteFeature first2, JsonWriteFeature ... other) {
        this._legacyEnable(first2.mappedFeature());
    ...
    @Override
    public JsonFactoryBuilder disable(JsonWriteFeature first2, JsonWriteFeature ... other) {
        this._legacyDisable(first2.mappedFeature());
        for (JsonWriteFeature f2 : other) {
            this._legacyDisable(f2.mappedFeature());
        }
