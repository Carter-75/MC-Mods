...
public final class CharsToNameCanonicalizer {
    ...
    private void rehash() {
        ...
        if (count2 != this._size) {
            throw new IllegalStateException(String.format("Internal error on SymbolTable.rehash(): had %d entries; now have %d", this._size, count2));
        }
    }
    ...
    protected void verifyInternalConsistency() {
        ...
        if (count2 != this._size) {
            throw new IllegalStateException(String.format("Internal error: expected internal size %d vs calculated count %d", this._size, count2));
        }
    }
    ...
    static final class Bucket {
        ...
        public Bucket(String s, Bucket n2) {
            this.symbol = s;
            this.next = n2;
