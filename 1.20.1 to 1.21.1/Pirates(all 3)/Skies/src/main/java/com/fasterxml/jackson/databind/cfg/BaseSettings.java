...
implements Serializable {
    ...
    public BaseSettings with(Locale l2) {
        ...
        return new BaseSettings(this._classIntrospector, this._annotationIntrospector, this._propertyNamingStrategy, this._typeFactory, this._typeResolverBuilder, this._dateFormat, this._handlerInstantiator, l2, this._timeZone, this._defaultBase64, this._typeValidator, this._accessorNaming);
    }
