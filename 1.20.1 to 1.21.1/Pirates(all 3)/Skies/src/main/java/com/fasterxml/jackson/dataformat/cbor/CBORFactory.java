...
extends JsonFactory {
    ...
    protected CBORFactory(CBORFactoryBuilder b2) {
        super(b2, false);
        this._formatParserFeatures = b2.formatParserFeaturesMask();
        this._formatGeneratorFeatures = b2.formatGeneratorFeaturesMask();
    }
    ...
    public final CBORFactory configure(CBORParser.Feature f2, boolean state) {
        if (state) {
            this.enable(f2);
        } else {
            this.disable(f2);
    ...
    public CBORFactory enable(CBORParser.Feature f2) {
        this._formatParserFeatures |= f2.getMask();
        return this;
    }

    public CBORFactory disable(CBORParser.Feature f2) {
        this._formatParserFeatures &= ~f2.getMask();
        return this;
    }

    public final boolean isEnabled(CBORParser.Feature f2) {
        return (this._formatParserFeatures & f2.getMask()) != 0;
    }
    ...
    public final CBORFactory configure(CBORGenerator.Feature f2, boolean state) {
        if (state) {
            this.enable(f2);
        } else {
            this.disable(f2);
    ...
    public CBORFactory enable(CBORGenerator.Feature f2) {
        this._formatGeneratorFeatures |= f2.getMask();
        return this;
    }

    public CBORFactory disable(CBORGenerator.Feature f2) {
        this._formatGeneratorFeatures &= ~f2.getMask();
        return this;
    }

    public final boolean isEnabled(CBORGenerator.Feature f2) {
        return (this._formatGeneratorFeatures & f2.getMask()) != 0;
    }
    ...
    @Override
    public CBORParser createParser(File f2) throws IOException {
