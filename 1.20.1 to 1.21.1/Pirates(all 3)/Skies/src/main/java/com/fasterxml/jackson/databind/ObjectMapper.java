...
Serializable {
    ...
    public JsonGenerator createGenerator(OutputStream out) throws IOException {
        ...
        JsonGenerator g2 = this._jsonFactory.createGenerator(out, JsonEncoding.UTF8);
        this._serializationConfig.initialize(g2);
        return g2;
    }

    public JsonGenerator createGenerator(OutputStream out, JsonEncoding enc) throws IOException {
        this._assertNotNull("out", out);
        JsonGenerator g2 = this._jsonFactory.createGenerator(out, enc);
        this._serializationConfig.initialize(g2);
        return g2;
    }
    ...
    public JsonGenerator createGenerator(Writer w) throws IOException {
        ...
        JsonGenerator g2 = this._jsonFactory.createGenerator(w);
        this._serializationConfig.initialize(g2);
        return g2;
    }
    ...
    public JsonGenerator createGenerator(File outputFile, JsonEncoding enc) throws IOException {
        ...
        JsonGenerator g2 = this._jsonFactory.createGenerator(outputFile, enc);
        this._serializationConfig.initialize(g2);
        return g2;
    }
    ...
    public JsonGenerator createGenerator(DataOutput out) throws IOException {
        this._assertNotNull("out", out);
        JsonGenerator g2 = this._jsonFactory.createGenerator(out);
        this._serializationConfig.initialize(g2);
        return g2;
    }
    ...
    public ObjectMapper enable(SerializationFeature first2, SerializationFeature ... f2) {
        this._serializationConfig = this._serializationConfig.with(first2, f2);
        return this;
    }
    ...
    public ObjectMapper disable(SerializationFeature first2, SerializationFeature ... f2) {
        this._serializationConfig = this._serializationConfig.without(first2, f2);
        return this;
    }
    ...
    public ObjectMapper enable(DeserializationFeature first2, DeserializationFeature ... f2) {
        this._deserializationConfig = this._deserializationConfig.with(first2, f2);
        return this;
    }
    ...
    public ObjectMapper disable(DeserializationFeature first2, DeserializationFeature ... f2) {
        this._deserializationConfig = this._deserializationConfig.without(first2, f2);
        return this;
    }

    public ObjectMapper configure(DatatypeFeature f2, boolean state) {
        if (state) {
            this._deserializationConfig = (DeserializationConfig)this._deserializationConfig.with(f2);
            this._serializationConfig = (SerializationConfig)this._serializationConfig.with(f2);
        } else {
    ...
    public <T extends TreeNode> T readTree(JsonParser p) throws IOException {
        ...
        JsonNode n2 = (JsonNode)this._readValue(cfg, p, this.constructType((Type)((Object)JsonNode.class)));
        if (n2 == null) {
    ...
    @Override
    public void writeValue(JsonGenerator g2, Object value) throws IOException, StreamWriteException, DatabindException {
    ...
    @Override
    public void writeTree(JsonGenerator g2, TreeNode rootNode) throws IOException {
        this._assertNotNull("g", g2);
        SerializationConfig config = this.getSerializationConfig();
    ...
    public void writeTree(JsonGenerator g2, JsonNode rootNode) throws IOException {
        this._assertNotNull("g", g2);
        SerializationConfig config = this.getSerializationConfig();
        this._serializerProvider(config).serializeValue(g2, rootNode);
        if (config.isEnabled(SerializationFeature.FLUSH_AFTER_WRITE_VALUE)) {
    ...
    @Override
    public <T> T treeToValue(TreeNode n2, Class<T> valueType) throws IllegalArgumentException, JsonProcessingException {
        if (n2 == null) {
            return null;
        }
        try {
            ...
            JsonToken tt = n2.asToken();
            if (tt == JsonToken.VALUE_EMBEDDED_OBJECT && n2 instanceof POJONode && ((ob = ((POJONode)n2).getPojo()) == null || valueType.isInstance(ob))) {
                return (T)ob;
            }
    ...
    public <T> T treeToValue(TreeNode n2, JavaType valueType) throws IllegalArgumentException, JsonProcessingException {
        if (n2 == null) {
            return null;
        }
        try {
            Object ob;
            if (valueType.isTypeOrSubTypeOf(TreeNode.class) && valueType.isTypeOrSuperTypeOf(n2.getClass())) {
                return (T)n2;
            }
            JsonToken tt = n2.asToken();
            if (tt == JsonToken.VALUE_EMBEDDED_OBJECT && n2 instanceof POJONode && ((ob = ((POJONode)n2).getPojo()) == null || valueType.isTypeOrSuperTypeOf(ob.getClass()))) {
                return (T)ob;
            }
            return this.readValue(this.treeAsTokens(n2), valueType);
        }
    ...
    public ObjectWriter writer(SerializationFeature first2, SerializationFeature ... other) {
        return this._newWriter(this.getSerializationConfig().with(first2, other));
    }
    ...
    public ObjectReader reader(DeserializationFeature first2, DeserializationFeature ... other) {
        return this._newReader(this.getDeserializationConfig().with(first2, other));
    }
    ...
    protected final void _writeValueAndClose(JsonGenerator g2, Object value) throws IOException {
        SerializationConfig cfg = this.getSerializationConfig();
        if (cfg.isEnabled(SerializationFeature.CLOSE_CLOSEABLE) && value instanceof Closeable) {
            this._writeCloseable(g2, value, cfg);
            return;
        }
        try {
    ...
    private final void _writeCloseable(JsonGenerator g2, Object value, SerializationConfig cfg) throws IOException {
    ...
    protected final void _configAndWriteValue(JsonGenerator g2, Object value) throws IOException {
        this.getSerializationConfig().initialize(g2);
        this._writeValueAndClose(g2, value);
    }
    ...
    protected Object _readValue(DeserializationConfig cfg, JsonParser p, JavaType valueType) throws IOException {
        ...
        Object result2 = t == JsonToken.VALUE_NULL ? this._findRootDeserializer(ctxt, valueType).getNullValue(ctxt) : (t == JsonToken.END_ARRAY || t == JsonToken.END_OBJECT ? null : ctxt.readRootValue(p, valueType, this._findRootDeserializer(ctxt, valueType), null));
        p.clearCurrentToken();
