...
public abstract class PropertySerializerMap {
    ...
    extends PropertySerializerMap {
        ...
        public Multi(PropertySerializerMap base, TypeAndSerializer[] entries2) {
            super(base);
        ...
        public PropertySerializerMap newWith(Class<?> type, JsonSerializer<Object> serializer) {
            ...
            TypeAndSerializer[] entries2 = Arrays.copyOf(this._entries, len + 1);
            entries2[len] = new TypeAndSerializer(type, serializer);
            return new Multi(this, entries2);
        }
    }
