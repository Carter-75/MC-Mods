...
public @interface JsonFormat {
    ...
    Serializable {
        ...
        public Value(String p, Shape sh, String localeStr, String tzStr, Features f2, Boolean lenient) {
            this(p, sh, localeStr == null || localeStr.length() == 0 || "##default".equals(localeStr) ? null : new Locale(localeStr), tzStr == null || tzStr.length() == 0 || "##default".equals(tzStr) ? null : tzStr, null, f2, lenient);
        }

        public Value(String p, Shape sh, Locale l2, TimeZone tz, Features f2, Boolean lenient) {
        ...
        public Value(String p, Shape sh, Locale l2, String tzStr, TimeZone tz, Features f2, Boolean lenient) {
            this._pattern = p == null ? "" : p;
            this._shape = sh == null ? Shape.ANY : sh;
            this._locale = l2;
            this._timezone = tz;
        ...
        public final Value withOverrides(Value overrides) {
            ...
            return new Value(p, sh, l2, tzStr, tz, f2, lenient);
        }
