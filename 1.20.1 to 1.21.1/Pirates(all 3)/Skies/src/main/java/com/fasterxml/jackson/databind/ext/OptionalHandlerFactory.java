...
implements Serializable {
    ...
    private Object instantiate(String className, JavaType valueType) {
        try {
            ...
            throw new IllegalStateException("Failed to find class `" + className + "` for handling values of type " + ClassUtil.getTypeDescription(valueType) + ", problem: (" + e2.getClass().getName() + ") " + e2.getMessage());
        }
    }
    ...
    private Object instantiate(Class<?> handlerClass, JavaType valueType) {
        try {
            ...
            throw new IllegalStateException("Failed to create instance of `" + handlerClass.getName() + "` for handling values of type " + ClassUtil.getTypeDescription(valueType) + ", problem: (" + e2.getClass().getName() + ") " + e2.getMessage());
        }
    }
