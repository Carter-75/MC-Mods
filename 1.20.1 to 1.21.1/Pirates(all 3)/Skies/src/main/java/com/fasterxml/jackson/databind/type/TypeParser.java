...
implements Serializable {
    ...
    protected List<JavaType> parseTypes(MyTokenizer tokens) throws IllegalArgumentException {
        ...
        while (tokens.hasMoreTokens()) {
            ...
            if (",".equals(token2)) continue;
            throw this._problem(tokens, "Unexpected token '" + token2 + "', expected ',' or '>')");
        }
        throw this._problem(tokens, "Unexpected end-of-string");
    }
    ...
    extends StringTokenizer {
        ...
        public String nextToken() {
            ...
            if (this._pushbackToken != null) {
                token2 = this._pushbackToken;
                this._pushbackToken = null;
            } else {
                token2 = super.nextToken();
        ...
        public void pushBack(String token2) {
            this._pushbackToken = token2;
        }
