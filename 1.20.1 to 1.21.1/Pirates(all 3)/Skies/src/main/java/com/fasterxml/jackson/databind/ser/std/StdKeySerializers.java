...
public abstract class StdKeySerializers {
    ...
    extends StdSerializer<Object> {
        ...
        public void serialize(Object value, JsonGenerator g2, SerializerProvider serializers) throws IOException {
            ...
            if (serializers.isEnabled(SerializationFeature.WRITE_ENUM_KEYS_USING_INDEX)) {
                g2.writeFieldName(String.valueOf(en.ordinal()));
                return;
            }
            g2.writeFieldName(this._values.serializedValueFor(en));
        }
    }
    ...
    extends StdSerializer<Object> {
        ...
        protected JsonSerializer<Object> _findAndAddDynamic(PropertySerializerMap map2, Class<?> type, SerializerProvider provider) throws JsonMappingException {
            if (type == Object.class) {
                Default ser = new Default(8, type);
                this._dynamicSerializers = map2.newWith(type, ser);
                return ser;
            }
            PropertySerializerMap.SerializerAndMapResult result2 = map2.findAndAddKeySerializer(type, provider, null);
            if (map2 != result2.map) {
