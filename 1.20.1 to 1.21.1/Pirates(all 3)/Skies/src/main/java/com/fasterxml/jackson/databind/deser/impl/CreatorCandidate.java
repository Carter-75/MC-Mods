...
public final class CreatorCandidate {
    ...
    protected CreatorCandidate(AnnotationIntrospector intr, AnnotatedWithParams ct, Param[] params, int count2) {
        this._intr = intr;
        this._creator = ct;
        this._params = params;
        this._paramCount = count2;
    }
    ...
    public static final class Param {
        ...
        public Param(AnnotatedParameter p, BeanPropertyDefinition pd, JacksonInject.Value i2) {
            this.annotated = p;
            this.propDef = pd;
            this.injection = i2;
        }
