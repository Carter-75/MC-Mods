    ...
    extends PrimitiveArrayDeserializers<double[]> {
        ...
        public double[] deserialize(JsonParser p, DeserializationContext ctxt) throws IOException {
            ...
            try {
                ...
                throw JsonMappingException.wrapWithPath((Throwable)e2, (Object)chunk, builder.bufferedSize() + ix);
            }
    ...
    extends PrimitiveArrayDeserializers<byte[]> {
        ...
        public byte[] deserialize(JsonParser p, DeserializationContext ctxt) throws IOException {
            ...
            try {
                ...
                throw JsonMappingException.wrapWithPath((Throwable)e3, (Object)chunk, builder.bufferedSize() + ix);
            }
            return builder.completeAndClearBuffer(chunk, ix);
        }
        ...
        protected byte[] handleSingleElementUnwrapped(JsonParser p, DeserializationContext ctxt) throws IOException {
            ...
            if (t == JsonToken.VALUE_NUMBER_INT) {
                ...
                Number n2 = (Number)ctxt.handleUnexpectedToken(this._valueClass.getComponentType(), p);
                value = n2.byteValue();
            }
