...
implements ContextualDeserializer {
    ...
    protected Collection<Object> _deserializeFromArray(JsonParser p, DeserializationContext ctxt, Collection<Object> result2) throws IOException {
        ...
        while ((t = p.nextToken()) != JsonToken.END_ARRAY) {
            try {
                ...
                throw JsonMappingException.wrapWithPath((Throwable)e2, result2, result2.size());
            }
        }
        return result2;
    }
    ...
    protected final Collection<Object> handleNonArray(JsonParser p, DeserializationContext ctxt, Collection<Object> result2) throws IOException {
        ...
        try {
            ...
            throw JsonMappingException.wrapWithPath((Throwable)e2, Object.class, result2.size());
        }
        result2.add(value);
        return result2;
    }
