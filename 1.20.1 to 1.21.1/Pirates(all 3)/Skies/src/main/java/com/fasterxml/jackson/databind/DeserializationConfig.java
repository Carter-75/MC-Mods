...
implements Serializable {
    ...
    public DeserializationConfig with(DeserializationFeature first2, DeserializationFeature ... features) {
        int newDeserFeatures = this._deserFeatures | first2.getMask();
    ...
    public DeserializationConfig without(DeserializationFeature first2, DeserializationFeature ... features) {
        int newDeserFeatures = this._deserFeatures & ~first2.getMask();
        for (DeserializationFeature f2 : features) {
            newDeserFeatures &= ~f2.getMask();
        }
    ...
    public TypeDeserializer findTypeDeserializer(JavaType baseType) throws JsonMappingException {
        ...
        TypeResolverBuilder<?> b2 = this.getAnnotationIntrospector().findTypeResolver(this, ac, baseType);
