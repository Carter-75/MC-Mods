...
public final class ObjectBuffer {
    ...
    public Object[] resetAndStart(Object[] base, int count2) {
        this._reset();
        if (this._freeBuffer == null || this._freeBuffer.length < count2) {
            this._freeBuffer = new Object[Math.max(12, count2)];
        }
        System.arraycopy(base, 0, this._freeBuffer, 0, count2);
        return this._freeBuffer;
    }
