...
extends PropertyWriter {
    ...
    @Override
    public void serializeAsField(Object map2, JsonGenerator gen, SerializerProvider provider) throws IOException {
    ...
    @Override
    public void serializeAsOmittedField(Object map2, JsonGenerator gen, SerializerProvider provider) throws Exception {
    ...
    @Override
    public void serializeAsElement(Object map2, JsonGenerator gen, SerializerProvider provider) throws Exception {
        if (this._typeSerializer == null) {
            this._valueSerializer.serialize(this._value, gen, provider);
        } else {
            this._valueSerializer.serializeWithType(this._value, gen, provider, this._typeSerializer);
