...
implements TypeResolutionContext {
    ...
    private final List<AnnotatedField> _fields() {
        ...
        if (f2 == null) {
            f2 = this._type == null ? Collections.emptyList() : AnnotatedFieldCollector.collectFields(this._annotationIntrospector, this, this._mixInResolver, this._typeFactory, this._type, this._collectAnnotations);
            this._fields = f2;
        }
        return f2;
    }
    ...
    private final AnnotatedMethodMap _methods() {
        ...
        if (m2 == null) {
            m2 = this._type == null ? new AnnotatedMethodMap() : AnnotatedMethodCollector.collectMethods(this._annotationIntrospector, this, this._mixInResolver, this._typeFactory, this._type, this._superTypes, this._primaryMixIn, this._collectAnnotations);
    ...
    private final Creators _creators() {
        ...
        if (c2 == null) {
            c2 = this._type == null ? NO_CREATORS : AnnotatedCreatorCollector.collectCreators(this._annotationIntrospector, this._typeFactory, this, this._type, this._primaryMixIn, this._collectAnnotations);
            this._creators = c2;
        }
        return c2;
    }
