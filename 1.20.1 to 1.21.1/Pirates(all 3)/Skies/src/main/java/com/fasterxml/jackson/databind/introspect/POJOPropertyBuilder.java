...
implements Comparable<POJOPropertyBuilder> {
    ...
    public PropertyMetadata getMetadata() {
        if (this._metadata == null) {
            ...
            if (prim == null) {
                ...
                Boolean b2 = this._annotationIntrospector.hasRequiredMarker(prim);
    ...
    protected PropertyMetadata _getSetterInfo(PropertyMetadata metadata, AnnotatedMember primary) {
        ...
        if (primary != null) {
            ...
            if (needMerge || valueNulls == null || contentNulls == null) {
                ...
                if (needMerge && acc != null && (b3 = co.getMergeable()) != null) {
                    needMerge = false;
                    if (b3.booleanValue()) {
        ...
        if (needMerge || valueNulls == null || contentNulls == null) {
            ...
            if (needMerge && Boolean.TRUE.equals(b4 = this._config.getDefaultMergeable()) && acc != null) {
    ...
    public JavaType getPrimaryType() {
        if (this._forSerialization) {
            ...
            if (m2 == null && (m2 = this.getField()) == null) {
                return TypeFactory.unknownType();
            }
            return ((Annotated)m2).getType();
        }
    ...
    public JsonInclude.Value findInclusion() {
        ...
        JsonInclude.Value v = this._annotationIntrospector == null ? null : this._annotationIntrospector.findPropertyInclusion(a2);
    ...
    private <T> boolean _anyExplicitsWithoutIgnoral(Linked<T> n2) {
        while (n2 != null) {
            if (!n2.isMarkedIgnored && n2.name != null && n2.name.hasSimpleName()) {
                return true;
            }
            n2 = n2.next;
        }
    ...
    private <T> boolean _anyExplicitNamesWithoutIgnoral(Linked<T> n2) {
        while (n2 != null) {
            if (!n2.isMarkedIgnored && n2.name != null && n2.isNameExplicit) {
                return true;
            }
            n2 = n2.next;
        }
    ...
    protected Class<?> _rawTypeOf(AnnotatedMember m2) {
        AnnotatedMethod meh;
        if (m2 instanceof AnnotatedMethod && (meh = (AnnotatedMethod)m2).getParameterCount() > 0) {
            return meh.getParameterType(0).getRawClass();
        }
        return m2.getType().getRawClass();
    }
    ...
    protected static final class Linked<T> {
        ...
        public Linked(T v, Linked<T> n2, PropertyName name, boolean explName, boolean visible, boolean ignored) {
            this.value = v;
            this.next = n2;
    ...
    implements Iterator<T> {
        ...
        public MemberIterator(Linked<T> first2) {
            this.next = first2;
        }
