...
extends ParserBase {
    ...
    private final void _isNextTokenNameYes(int i2) throws IOException {
        ...
        switch (i2) {
            ...
            case 43: {
                this._nextToken = this.isEnabled(JsonReadFeature.ALLOW_LEADING_PLUS_SIGN_FOR_NUMBERS.mappedFeature()) ? this._parseSignedNumber(false) : this._handleOddValue(i2);
                return;
            }
            case 46: {
