...
public interface VisibilityChecker<T extends VisibilityChecker<T>> {
    ...
    Serializable {
        ...
        protected Std _with(JsonAutoDetect.Visibility g2, JsonAutoDetect.Visibility isG, JsonAutoDetect.Visibility s, JsonAutoDetect.Visibility cr, JsonAutoDetect.Visibility f2) {
            if (g2 == this._getterMinLevel && isG == this._isGetterMinLevel && s == this._setterMinLevel && cr == this._creatorMinLevel && f2 == this._fieldMinLevel) {
                return this;
            }
            return new Std(g2, isG, s, cr, f2);
        }
