...
public final class ClassUtil {
    ...
    public static Ctor[] getConstructors(Class<?> cls) {
        ...
        for (int i2 = 0; i2 < len; ++i2) {
            result2[i2] = new Ctor(rawCtors[i2]);
        }
        return result2;
    }
    ...
    public static final class Ctor {
        ...
        public int getParamCount() {
            ...
            if (c2 < 0) {
                this._paramCount = c2 = this._ctor.getParameterCount();
            }
            return c2;
        }
    ...
    private static class EnumTypeLocator {
        ...
        private EnumTypeLocator() {
            ...
            String msg = null;
            try {
                f2 = EnumTypeLocator.locateField(EnumSet.class, "elementType", Class.class);
            }
            catch (Exception e2) {
                msg = e2.toString();
            }
            this.enumSetTypeField = f2;
            this.failForEnumSet = msg;
            f2 = null;
            msg = null;
            try {
                f2 = EnumTypeLocator.locateField(EnumMap.class, "keyType", Class.class);
            }
            catch (Exception e3) {
                msg = e3.toString();
            }
        ...
        private static Field locateField(Class<?> fromClass, String expectedName, Class<?> type) throws Exception {
            Field[] fields;
            for (Field f2 : fields = fromClass.getDeclaredFields()) {
