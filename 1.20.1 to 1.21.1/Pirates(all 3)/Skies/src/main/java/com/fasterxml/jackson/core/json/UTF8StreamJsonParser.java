...
extends ParserBase {
    ...
    protected final boolean _loadMore() throws IOException {
        if (this._inputStream != null) {
            ...
            int count2 = this._inputStream.read(this._inputBuffer, 0, space);
            if (count2 > 0) {
    ...
    public JsonToken nextToken() throws IOException {
        ...
        switch (i2) {
            ...
            case 43: {
                ...
                t = this._handleUnexpectedValue(i2);
                break;
            }
            case 46: {
            ...
            case 56: 
            case 57: {
                t = this._parseUnsignedNumber(i2);
                break;
            }
            case 102: {
                this._matchFalse();
    ...
    private final JsonToken _nextTokenNotInObject(int i2) throws IOException {
        ...
        switch (i2) {
            ...
            case 56: 
            case 57: {
                this._currToken = this._parseUnsignedNumber(i2);
                return this._currToken;
            }
        }
        this._currToken = this._handleUnexpectedValue(i2);
    ...
    private final void _isNextTokenNameYes(int i2) throws IOException {
        ...
        switch (i2) {
            ...
            case 43: {
                this._nextToken = this.isEnabled(JsonReadFeature.ALLOW_LEADING_PLUS_SIGN_FOR_NUMBERS.mappedFeature()) ? this._parseSignedNumber(false) : this._handleUnexpectedValue(i2);
                return;
            }
            case 46: {
            ...
            case 56: 
            case 57: {
                this._nextToken = this._parseUnsignedNumber(i2);
                return;
            }
        }
    ...
    protected JsonToken _parseUnsignedNumber(int c2) throws IOException {
        char[] outBuf = this._textBuffer.emptyAndGetCurrentSegment();
        if (c2 == 48) {
    ...
    private final JsonToken _parseSignedNumber(boolean negative) throws IOException {
        ...
        if ((c2 = this._inputBuffer[this._inputPtr++] & 0xFF) <= 48) {
            if (c2 != 48) {
                ...
                return this._handleInvalidNumberStart(c2, negative, true);
            }
            c2 = this._verifyNoLeadingZeroes();
        } else if (c2 > 57) {
            return this._handleInvalidNumberStart(c2, negative, true);
        ...
        if (c2 == 46 || c2 == 101 || c2 == 69) {
            return this._parseFloat(outBuf, outPtr, c2, negative, intLen);
        }
        --this._inputPtr;
        this._textBuffer.setCurrentLength(outPtr);
        if (this._parsingContext.inRoot()) {
            ...
            if (codes[i2 = input[this._inputPtr++] & 0xFF] == 0) {
                ...
                if (codes[i2 = input[this._inputPtr++] & 0xFF] == 0) {
                    ...
                    if (codes[i2 = input[this._inputPtr++] & 0xFF] == 0) {
                        ...
                        return this.parseName(q, i2, 4);
                    }
                    if (i2 == 34) {
                        return this.findName(q, 3);
                    }
                    return this.parseName(q, i2, 3);
                }
                if (i2 == 34) {
                    return this.findName(q, 2);
                }
                return this.parseName(q, i2, 2);
            }
            if (i2 == 34) {
                return this.findName(q, 1);
            }
            return this.parseName(q, i2, 1);
        }
        if (q == 34) {
            return "";
        }
    ...
    protected final String parseLongName(int q, int q2, int q3) throws IOException {
        ...
        while (this._inputPtr + 4 <= this._inputEnd) {
            ...
            if (codes[i2 = input[this._inputPtr++] & 0xFF] != 0) {
                ...
                return this.parseEscapedName(this._quadBuffer, qlen, q, i2, 1);
            }
            q = q << 8 | i2;
            if (codes[i2 = input[this._inputPtr++] & 0xFF] != 0) {
                if (i2 == 34) {
                ...
                return this.parseEscapedName(this._quadBuffer, qlen, q, i2, 2);
            }
            q = q << 8 | i2;
            if (codes[i2 = input[this._inputPtr++] & 0xFF] != 0) {
                if (i2 == 34) {
                ...
                return this.parseEscapedName(this._quadBuffer, qlen, q, i2, 3);
            }
            q = q << 8 | i2;
            if (codes[i2 = input[this._inputPtr++] & 0xFF] != 0) {
                if (i2 == 34) {
                ...
                return this.parseEscapedName(this._quadBuffer, qlen, q, i2, 4);
            }
    ...
    protected JsonToken _handleApos() throws IOException {
        ...
        block6: while (true) {
            ...
            while (true) {
                ...
                if ((c2 = inputBuffer[this._inputPtr++] & 0xFF) == 39) break block6;
                if (codes[c2] != 0 && c2 != 34) break;
                outBuf[outPtr++] = (char)c2;
            }
            switch (codes[c2]) {
                case 1: {
