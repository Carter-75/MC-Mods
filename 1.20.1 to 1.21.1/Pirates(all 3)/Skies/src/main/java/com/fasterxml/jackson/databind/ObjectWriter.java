...
Serializable {
    ...
    public ObjectWriter with(SerializationFeature first2, SerializationFeature ... other) {
        return this._new(this, this._config.with(first2, other));
    }
    ...
    public ObjectWriter without(SerializationFeature first2, SerializationFeature ... other) {
        return this._new(this, this._config.without(first2, other));
    }
    ...
    public SequenceWriter writeValues(JsonGenerator g2) throws IOException {
        ...
        return this._newSequenceWriter(false, this._configureGenerator(g2), false);
    }
