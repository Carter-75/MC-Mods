...
ResolvableDeserializer {
                ...
                if (key == null) {
                    ...
                    block12: {
                        try {
                            ...
                            return (EnumMap)this.wrapAndThrow(ctxt, e2, result2, keyStr);
                        }
                    }
    ...
    public EnumMap<?, ?> _deserializeUsingProperties(JsonParser p, DeserializationContext ctxt) throws IOException {
                ...
                if (prop != null) {
                    if (buffer.assignParameter(prop, prop.deserialize(p, ctxt))) {
                        ...
                        try {
                            ...
                            return (EnumMap)this.wrapAndThrow(ctxt, e2, this._containerType.getRawClass(), keyName);
                        }
                    ...
                    if (key == null) {
                        ...
                        block15: {
                            try {
                                ...
                                this.wrapAndThrow(ctxt, e3, this._containerType.getRawClass(), keyName);
                                return null;
                            }
                        }
        ...
        try {
            ...
            this.wrapAndThrow(ctxt, e4, this._containerType.getRawClass(), keyName);
            return null;
        }
    }
}
