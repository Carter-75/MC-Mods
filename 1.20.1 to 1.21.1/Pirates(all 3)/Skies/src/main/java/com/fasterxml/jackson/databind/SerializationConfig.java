...
implements Serializable {
    ...
    public SerializationConfig with(SerializationFeature first2, SerializationFeature ... features) {
        int newSerFeatures = this._serFeatures | first2.getMask();
    ...
    public SerializationConfig without(SerializationFeature first2, SerializationFeature ... features) {
        int newSerFeatures = this._serFeatures & ~first2.getMask();
        for (SerializationFeature f2 : features) {
            newSerFeatures &= ~f2.getMask();
        }
    ...
    public void initialize(JsonGenerator g2) {
        PrettyPrinter pp;
        if (SerializationFeature.INDENT_OUTPUT.enabledIn(this._serFeatures) && g2.getPrettyPrinter() == null && (pp = this.constructDefaultPrettyPrinter()) != null) {
