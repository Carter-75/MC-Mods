...
public class NordicCivilianModel<T extends NordicCivilianEntity>
extends class_5597<T> {
    private final class_630 body;
    private final class_630 head;

    public NordicCivilianModel(class_630 root) {
    ...
    public static class_5607 getTexturedModelData() {
        ...
        class_5610 leftarm = body.method_32117("leftarm", class_5606.method_32108().method_32101(16, 32).method_32098(-1.0f, -2.0f, -2.0f, 4.0f, 12.0f, 4.0f, new class_5605(0.0f)), class_5603.method_32090((float)5.0f, (float)2.0f, (float)0.0f));
        class_5610 axe = leftarm.method_32117("axe", class_5606.method_32108().method_32101(32, 56).method_32098(-1.0f, -6.0333f, -3.9333f, 1.0f, 1.0f, 4.0f, new class_5605(0.0f)).method_32101(48, 55).method_32098(-1.0f, -5.0333f, -3.9333f, 1.0f, 1.0f, 5.0f, new class_5605(0.0f)).method_32101(48, 40).method_32098(-1.0f, -4.0333f, -4.9333f, 1.0f, 1.0f, 7.0f, new class_5605(0.0f)).method_32101(48, 32).method_32098(-1.0f, -3.0333f, -4.9333f, 1.0f, 1.0f, 7.0f, new class_5605(0.0f)).method_32101(32, 48).method_32098(-1.0f, -2.0333f, -5.9333f, 1.0f, 1.0f, 7.0f, new class_5605(0.0f)).method_32101(48, 48).method_32098(-1.0f, -1.0333f, -5.9333f, 1.0f, 1.0f, 6.0f, new class_5605(0.0f)).method_32101(62, 52).method_32098(-1.0f, -0.0333f, -4.9333f, 1.0f, 1.0f, 2.0f, new class_5605(0.0f)).method_32101(62, 48).method_32098(-1.0f, -0.0333f, -1.9333f, 1.0f, 1.0f, 3.0f, new class_5605(0.0f)).method_32101(48, 61).method_32098(-1.0f, 0.9667f, -0.9333f, 1.0f, 1.0f, 3.0f, new class_5605(0.0f)).method_32101(40, 61).method_32098(-1.0f, 1.9667f, 0.0667f, 1.0f, 1.0f, 3.0f, new class_5605(0.0f)).method_32101(32, 61).method_32098(-1.0f, 2.9667f, 1.0667f, 1.0f, 1.0f, 3.0f, new class_5605(0.0f)).method_32101(60, 59).method_32098(-1.0f, 3.9667f, 2.0667f, 1.0f, 1.0f, 3.0f, new class_5605(0.0f)).method_32101(60, 55).method_32098(-1.0f, 4.9667f, 3.0667f, 1.0f, 1.0f, 3.0f, new class_5605(0.0f)).method_32101(42, 56).method_32098(-1.0f, 5.9667f, 4.0667f, 1.0f, 1.0f, 2.0f, new class_5605(0.0f)).method_32101(56, 63).method_32098(-1.0f, -7.0333f, -2.9333f, 1.0f, 1.0f, 2.0f, new class_5605(0.0f)), class_5603.method_32091((float)0.0f, (float)10.0333f, (float)-7.0667f, (float)0.7854f, (float)0.0f, (float)-3.1416f));
        ...
        class_5610 leftleg = body.method_32117("leftleg", class_5606.method_32108().method_32101(16, 48).method_32098(-1.9f, 0.0f, -2.0f, 4.0f, 12.0f, 4.0f, new class_5605(0.0f)), class_5603.method_32090((float)1.9f, (float)12.0f, (float)0.0f));
    ...
    public void setAngles(NordicCivilianEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
        ...
        this.method_43782(entity.attackAnimationState, ModAnimations.NORDIC_CIVILIAN_ATTACK, ageInTicks, 1.0f);
    }
