...
public class NordicCivilianAttackGoal
extends class_1366 {
    ...
    public NordicCivilianAttackGoal(class_1314 mob, double speed, boolean pauseWhenMobIdle) {
        super(mob, speed, pauseWhenMobIdle);
        this.entity = (NordicCivilianEntity)mob;
    }
