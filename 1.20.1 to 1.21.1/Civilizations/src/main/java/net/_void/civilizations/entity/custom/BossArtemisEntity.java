...
public class BossArtemisEntity
extends class_1429 {
    private static final class_2940<Boolean> SHOOTING = class_2945.method_12791(BossArtemisEntity.class, (class_2941)class_2943.field_13323);
    public final class_7094 idleAnimationState = new class_7094();
    private int idleAnimationTimeout = 0;
    public final class_7094 shootingAnimationState = new class_7094();
    public int shootingAnimationTimeout = 0;
    private static class_2940<Integer> X = class_2945.method_12791(BossArtemisEntity.class, (class_2941)class_2943.field_13327);
    private static class_2940<Integer> Y = class_2945.method_12791(BossArtemisEntity.class, (class_2941)class_2943.field_13327);
    private static class_2940<Integer> Z = class_2945.method_12791(BossArtemisEntity.class, (class_2941)class_2943.field_13327);
    private int damageTaken = 0;
    private static class_2940<Integer> MODE = class_2945.method_12791(BossArtemisEntity.class, (class_2941)class_2943.field_13327);
    private final class_3213 bossBar = new class_3213((class_2561)class_2561.method_43471((String)"entity.civilizations.boss_artemis"), class_1259.class_1260.field_5785, class_1259.class_1261.field_5790);
    ...
    public void setMode(int mode) {
        this.field_6011.method_12778(MODE, (Object)mode);
    }

    public int getMode() {
        return (Integer)this.field_6011.method_12789(MODE);
    }

    public BossArtemisEntity(class_1299<? extends class_1429> entityType, class_1937 world) {
    ...
    public void method_5773() {
        ...
        for (class_1657 player : this.method_37908().method_18456()) {
            ...
            if (player.method_5858((class_1297)this) <= 2500.0) {
                ...
                buffer.method_10814("GreeceGodPlay");
            ...
            buffer = PacketByteBufs.create();
            buffer.method_10814("GreeceGodStop");
            ServerPlayNetworking.send((class_3222)((class_3222)player), (class_2960)ModMessages.BOSS_MUSIC_PLAY, (class_2540)buffer);
        }
    }
    ...
    protected void method_5959() {
        ...
        this.field_6201.method_6277(1, (class_1352)new BossArtemisGoal((class_1314)this));
    ...
    public static class_5132.class_5133 createBossAttributes() {
        return class_1308.method_26828().method_26868(class_5134.field_23716, 1200.0).method_26868(class_5134.field_23724, 5.0).method_26868(class_5134.field_23721, 9.0).method_26868(class_5134.field_23719, (double)0.3f).method_26868(class_5134.field_23717, 75.0).method_26868(class_5134.field_23718, 2.0);
    }
    ...
    protected void method_5958() {
        ...
        if ((class_12972 = this.method_5968()) instanceof class_1657) {
            class_1657 player = (class_1657)class_12972;
            if (player.method_23318() > this.method_23318() + 3.0 || player.method_23318() < this.method_23318() - 3.0) {
                this.setMode(1);
            } else {
                this.setMode(0);
            }
        }
        if (this.damageTaken >= 220) {
            this.damageTaken = 0;
            class_1584 customEntity = (class_1584)((class_1299)class_1299.method_5898((String)"minecraft:ravager").get()).method_5883(this.method_37908());
            ...
            customEntity.method_6092(new class_1293(class_1294.field_5918, 600, 0, false, false));
            class_1584 customEntity2 = (class_1584)((class_1299)class_1299.method_5898((String)"minecraft:ravager").get()).method_5883(this.method_37908());
            customEntity2.method_30634(this.method_23317(), this.method_23318(), this.method_23321());
            this.method_37908().method_8649((class_1297)customEntity2);
            customEntity2.method_6092(new class_1293(class_1294.field_5918, 600, 0, false, false));
        }
    }
    ...
    protected void method_5693() {
        ...
        this.field_6011.method_12784(MODE, (Object)0);
    }
    ...
    public boolean method_5643(class_1282 source, float amount) {
        ...
        if (attacker instanceof class_1657) {
            this.damageTaken = (int)((float)this.damageTaken + amount);
        }
        if (attacker instanceof class_1584) {
            class_1584 ravager = (class_1584)attacker;
            class_2338 pos = ravager.method_24515();
            ravager.method_5768();
            class_1584 customEntity = (class_1584)((class_1299)class_1299.method_5898((String)"minecraft:ravager").get()).method_5883(this.method_37908());
            customEntity.method_30634((double)pos.method_10263(), (double)pos.method_10264(), (double)pos.method_10260());
            this.method_37908().method_8649((class_1297)customEntity);
            customEntity.method_6092(new class_1293(class_1294.field_5918, 600, 0, false, false));
            return false;
        }
    ...
    public void method_6078(class_1282 damageSource) {
        ...
        class_1542 itemEntity = new class_1542(this.method_37908(), (double)((Integer)this.field_6011.method_12789(X)).intValue() + 0.5, (double)((Integer)this.field_6011.method_12789(Y)).intValue(), (double)((Integer)this.field_6011.method_12789(Z)).intValue() + 0.5, new class_1799((class_1935)ModItems.ARTEMIS_BOW));
