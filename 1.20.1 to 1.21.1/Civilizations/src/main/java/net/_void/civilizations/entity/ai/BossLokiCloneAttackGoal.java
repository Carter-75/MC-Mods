...
public class BossLokiCloneAttackGoal
extends class_1366 {
    ...
    public BossLokiCloneAttackGoal(class_1314 mob, double speed, boolean pauseWhenMobIdle) {
        super(mob, speed, pauseWhenMobIdle);
        this.entity = (BossLokiCloneEntity)mob;
    }
