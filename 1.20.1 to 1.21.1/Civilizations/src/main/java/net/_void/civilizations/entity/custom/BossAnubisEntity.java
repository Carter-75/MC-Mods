...
public class BossAnubisEntity
extends class_1429 {
    private static final class_2940<Boolean> ATTACK = class_2945.method_12791(BossAnubisEntity.class, (class_2941)class_2943.field_13323);
    private static final class_2940<Boolean> SPELL = class_2945.method_12791(BossAnubisEntity.class, (class_2941)class_2943.field_13323);
    public final class_7094 idleAnimationState = new class_7094();
    private int idleAnimationTimeout = 0;
    public final class_7094 attackAnimationState = new class_7094();
    public int attackAnimationTimeout = 0;
    public final class_7094 spellAnimationState = new class_7094();
    public int spellAnimationTimeout = 0;
    private static class_2940<Integer> X = class_2945.method_12791(BossAnubisEntity.class, (class_2941)class_2943.field_13327);
    private static class_2940<Integer> Y = class_2945.method_12791(BossAnubisEntity.class, (class_2941)class_2943.field_13327);
    private static class_2940<Integer> Z = class_2945.method_12791(BossAnubisEntity.class, (class_2941)class_2943.field_13327);
    private final class_3213 bossBar = new class_3213((class_2561)class_2561.method_43471((String)"entity.civilizations.boss_anubis"), class_1259.class_1260.field_5782, class_1259.class_1261.field_5790);
    ...
    public BossAnubisEntity(class_1299<? extends class_1429> entityType, class_1937 world) {
    ...
    private void setupAnimationStates() {
        ...
        if (this.isSpelling() && this.spellAnimationTimeout <= 0) {
            this.spellAnimationTimeout = 40;
            this.spellAnimationState.method_41322(this.field_6012);
        } else {
            --this.spellAnimationTimeout;
        }
        if (!this.isSpelling()) {
            this.spellAnimationState.method_41325();
        }
    }
    ...
    public void method_5773() {
        ...
        for (class_1657 player : this.method_37908().method_18456()) {
            ...
            if (player.method_5858((class_1297)this) <= 2500.0) {
                ...
                buffer.method_10814("EgyptGodPlay");
            ...
            buffer = PacketByteBufs.create();
            buffer.method_10814("EgyptGodStop");
            ServerPlayNetworking.send((class_3222)((class_3222)player), (class_2960)ModMessages.BOSS_MUSIC_PLAY, (class_2540)buffer);
        }
    }
    ...
    protected void method_5959() {
        ...
        this.field_6201.method_6277(1, (class_1352)new BossAnubisSpellGoal((class_1314)this));
        this.field_6201.method_6277(1, (class_1352)new BossAnubisAttackGoal((class_1314)this, 1.0, true));
    ...
    public static class_5132.class_5133 createBossAttributes() {
        return class_1308.method_26828().method_26868(class_5134.field_23716, 1200.0).method_26868(class_5134.field_23724, 5.0).method_26868(class_5134.field_23721, 12.0).method_26868(class_5134.field_23719, 0.0).method_26868(class_5134.field_23717, 75.0).method_26868(class_5134.field_23722, 2.0).method_26868(class_5134.field_23718, 2.0);
    }
    ...
    public void setSpelling(boolean spelling) {
        this.field_6011.method_12778(SPELL, (Object)spelling);
    }

    public boolean isSpelling() {
        return (Boolean)this.field_6011.method_12789(SPELL);
    }
    ...
    protected void method_5693() {
        ...
        this.field_6011.method_12784(SPELL, (Object)false);
    ...
    public boolean method_5643(class_1282 source, float amount) {
        ...
        if (class_12972 instanceof class_1657 && ((player = (class_1657)class_12972).method_23318() > this.method_23318() + 5.0 || player.method_23318() < this.method_23318() - 5.0)) {
            return false;
        }
    ...
    public void method_6078(class_1282 damageSource) {
        ...
        class_1542 itemEntity = new class_1542(this.method_37908(), (double)((Integer)this.field_6011.method_12789(X)).intValue() + 0.5, (double)((Integer)this.field_6011.method_12789(Y)).intValue(), (double)((Integer)this.field_6011.method_12789(Z)).intValue() + 0.5, new class_1799((class_1935)ModItems.ANUBIS_ANKH));
