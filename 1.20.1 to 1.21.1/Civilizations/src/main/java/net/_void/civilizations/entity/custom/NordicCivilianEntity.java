...
public class NordicCivilianEntity
extends class_1429 {
    private static final class_2940<Boolean> ATTACKING = class_2945.method_12791(NordicCivilianEntity.class, (class_2941)class_2943.field_13323);
    public final class_7094 idleAnimationState = new class_7094();
    private int idleAnimationTimeout = 0;
    public final class_7094 attackAnimationState = new class_7094();
    public int attackAnimationTimeout = 0;
    private static final class_2940<Integer> DATA_ID_TYPE_VARIANT = class_2945.method_12791(NordicCivilianEntity.class, (class_2941)class_2943.field_13327);

    public NordicCivilianEntity(class_1299<? extends class_1429> entityType, class_1937 world) {
    ...
    protected void method_5959() {
        ...
        this.field_6201.method_6277(1, (class_1352)new NordicCivilianAttackGoal((class_1314)this, 1.0, true));
    ...
    public static class_5132.class_5133 createCivilianAttributes() {
        return class_1308.method_26828().method_26868(class_5134.field_23716, 20.0).method_26868(class_5134.field_23724, 2.0).method_26868(class_5134.field_23721, 5.0).method_26868(class_5134.field_23719, 0.25).method_26868(class_5134.field_23717, 50.0);
    }
    ...
    public class_1296 method_5613(class_3218 world, class_1296 entity) {
        NordicCivilianEntity baby = (NordicCivilianEntity)ModEntities.NORDIC_CIVILIAN.method_5883((class_1937)world);
        NordicCivilianVariant variant = (NordicCivilianVariant)((Object)class_156.method_27173((Object[])NordicCivilianVariant.values(), (class_5819)this.field_5974));
    ...
    public NordicCivilianVariant getVariant() {
        return NordicCivilianVariant.byId(this.getTypeVariant() & 0xFF);
    }
