...
public class GreeceCivilianAttackGoal
extends class_1366 {
    ...
    public GreeceCivilianAttackGoal(class_1314 mob, double speed, boolean pauseWhenMobIdle) {
        super(mob, speed, pauseWhenMobIdle);
        this.entity = (GreeceCivilianEntity)mob;
    }
