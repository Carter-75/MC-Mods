...
public class EgyptBossEntity
extends class_1429 {
    private static final class_2940<Boolean> SHOOTING = class_2945.method_12791(EgyptBossEntity.class, (class_2941)class_2943.field_13323);
    private static final class_2940<Boolean> ATTACKING = class_2945.method_12791(EgyptBossEntity.class, (class_2941)class_2943.field_13323);
    ...
    private final class_3213 bossBar = new class_3213((class_2561)class_2561.method_43471((String)"entity.civilizations.egypt_boss"), class_1259.class_1260.field_5782, class_1259.class_1261.field_5790);

    public EgyptBossEntity(class_1299<? extends class_1429> entityType, class_1937 world) {
    ...
    public void method_5773() {
        ...
        for (class_1657 player : this.method_37908().method_18456()) {
            ...
            if (player.method_5858((class_1297)this) <= 2500.0) {
                ...
                buffer.method_10814("EgyptBossPlay");
            ...
            buffer = PacketByteBufs.create();
            buffer.method_10814("EgyptBossStop");
            ServerPlayNetworking.send((class_3222)((class_3222)player), (class_2960)ModMessages.BOSS_MUSIC_PLAY, (class_2540)buffer);
        }
    }
    ...
    protected void method_5959() {
        ...
        this.field_6201.method_6277(1, (class_1352)new EgyptBossShootGoal((class_1314)this));
        this.field_6201.method_6277(1, (class_1352)new EgyptBossAttackGoal((class_1314)this, 1.0, true));
    ...
    public static class_5132.class_5133 createBossAttributes() {
        return class_1308.method_26828().method_26868(class_5134.field_23716, 1000.0).method_26868(class_5134.field_23724, 5.0).method_26868(class_5134.field_23721, 5.0).method_26868(class_5134.field_23719, (double)0.3f).method_26868(class_5134.field_23717, 100.0).method_26868(class_5134.field_23722, 2.0).method_26868(class_5134.field_23718, 0.5);
    }
    ...
    public boolean method_5643(class_1282 source, float amount) {
        if (source.method_49708(class_8111.field_42331) || source.method_49708(class_8111.field_42332) || source.method_49708(class_8111.field_42326) || source.method_49708(class_8111.field_42325) || source.method_49708(class_8111.field_42335) || source.method_49708(class_8111.field_42337) || source.method_49708(class_8111.field_42338) || source.method_49708(class_8111.field_42345) || source.method_49708(class_8111.field_42342) || source.method_49708(class_8111.field_42340)) {
            return false;
        }
    ...
    protected void method_6099(class_1282 source, int lootingMultiplier, boolean allowDrops) {
        class_1542 itemEntity4;
        class_1542 itemEntity3;
        class_1542 itemEntity2;
        super.method_6099(source, lootingMultiplier, allowDrops);
        class_1542 itemEntity = this.method_5706((class_1935)class_1802.field_8288);
        if (itemEntity != null) {
            itemEntity.method_6976();
            itemEntity.method_5684(true);
        }
        if ((itemEntity2 = this.method_5706((class_1935)class_1802.field_8367)) != null) {
            itemEntity2.method_6976();
            itemEntity2.method_5684(true);
        }
        if ((itemEntity3 = this.method_5706((class_1935)ModItems.EGYPT_CROOK)) != null) {
            itemEntity3.method_6976();
            itemEntity3.method_5684(true);
        }
        if ((itemEntity4 = this.method_5706((class_1935)ModItems.EGYPT_CORE)) != null) {
            itemEntity4.method_6976();
            itemEntity4.method_5684(true);
        }
    }
