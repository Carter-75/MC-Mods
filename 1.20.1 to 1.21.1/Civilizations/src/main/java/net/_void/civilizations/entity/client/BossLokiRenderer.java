...
public class BossLokiRenderer
extends class_927<BossLokiEntity, BossLokiModel<BossLokiEntity>> {
    private static final class_2960 TEXTURE = new class_2960("civilizations", "textures/entity/boss_loki.png");

    public BossLokiRenderer(class_5617.class_5618 context) {
        super(context, new BossLokiModel(context.method_32167(ModModelLayers.BOSS_LOKI)), 0.6f);
    }

    public class_2960 getTexture(BossLokiEntity entity) {
        return TEXTURE;
    }

    public void render(BossLokiEntity mobEntity, float f, float g, class_4587 matrixStack, class_4597 vertexConsumerProvider, int i) {
