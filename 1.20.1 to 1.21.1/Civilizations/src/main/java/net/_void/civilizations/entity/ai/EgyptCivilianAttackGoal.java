...
public class EgyptCivilianAttackGoal
extends class_1366 {
    ...
    public EgyptCivilianAttackGoal(class_1314 mob, double speed, boolean pauseWhenMobIdle) {
        super(mob, speed, pauseWhenMobIdle);
        this.entity = (EgyptCivilianEntity)mob;
    }
