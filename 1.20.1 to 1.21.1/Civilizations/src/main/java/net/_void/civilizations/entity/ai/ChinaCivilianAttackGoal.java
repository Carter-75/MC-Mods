...
public class ChinaCivilianAttackGoal
extends class_1366 {
    ...
    public ChinaCivilianAttackGoal(class_1314 mob, double speed, boolean pauseWhenMobIdle) {
        super(mob, speed, pauseWhenMobIdle);
        this.entity = (ChinaCivilianEntity)mob;
    }
