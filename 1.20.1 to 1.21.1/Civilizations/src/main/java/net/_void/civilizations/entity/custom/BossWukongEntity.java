...
public class BossWukongEntity
extends class_1429 {
    private static final class_2940<Boolean> ATTACK = class_2945.method_12791(BossWukongEntity.class, (class_2941)class_2943.field_13323);
    private static final class_2940<Boolean> SPELL = class_2945.method_12791(BossWukongEntity.class, (class_2941)class_2943.field_13323);
    ...
    private static class_2940<Integer> X = class_2945.method_12791(BossWukongEntity.class, (class_2941)class_2943.field_13327);
    private static class_2940<Integer> Y = class_2945.method_12791(BossWukongEntity.class, (class_2941)class_2943.field_13327);
    private static class_2940<Integer> Z = class_2945.method_12791(BossWukongEntity.class, (class_2941)class_2943.field_13327);
    private int damageTaken = 0;
    private final class_3213 bossBar = new class_3213((class_2561)class_2561.method_43471((String)"entity.civilizations.boss_wukong"), class_1259.class_1260.field_5784, class_1259.class_1261.field_5790);
    ...
    public BossWukongEntity(class_1299<? extends class_1429> entityType, class_1937 world) {
    ...
    public void method_5773() {
        ...
        for (class_1657 player : this.method_37908().method_18456()) {
            ...
            if (player.method_5858((class_1297)this) <= 2500.0) {
                ...
                buffer.method_10814("ChinaGodPlay");
            ...
            buffer = PacketByteBufs.create();
            buffer.method_10814("ChinaGodStop");
            ServerPlayNetworking.send((class_3222)((class_3222)player), (class_2960)ModMessages.BOSS_MUSIC_PLAY, (class_2540)buffer);
        }
    }
    ...
    protected void method_5959() {
        ...
        this.field_6201.method_6277(1, (class_1352)new BossWukongAttackGoal((class_1314)this));
    ...
    public void setSpelling(boolean spell) {
        this.field_6011.method_12778(SPELL, (Object)spell);
    }
    ...
    protected void method_5958() {
        ...
        if (this.damageTaken >= 230) {
            this.damageTaken = 0;
            for (int i = -5; i <= 5; i += 10) {
                for (int j = -5; j <= 5; j += 10) {
                    class_1545 customEntity = (class_1545)((class_1299)class_1299.method_5898((String)"minecraft:blaze").get()).method_5883(this.method_37908());
                    customEntity.method_30634(this.method_23317() + (double)i, this.method_23318(), this.method_23321() + (double)j);
    ...
    public void method_6078(class_1282 damageSource) {
        ...
        class_1542 itemEntity = new class_1542(this.method_37908(), (double)((Integer)this.field_6011.method_12789(X)).intValue() + 0.5, (double)((Integer)this.field_6011.method_12789(Y)).intValue(), (double)((Integer)this.field_6011.method_12789(Z)).intValue() + 0.5, new class_1799((class_1935)ModItems.WUKONG_SWORD));
