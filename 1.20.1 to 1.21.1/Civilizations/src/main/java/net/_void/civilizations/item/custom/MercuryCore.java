...
extends class_1792 {
    ...
    public MercuryCore(class_1792.class_1793 settings) {
        super(settings);
    }

    public void method_7851(class_1799 stack, @Nullable class_1937 world, List<class_2561> tooltip, class_1836 context) {
        tooltip.add((class_2561)class_2561.method_43471((String)"tooltip.civilizations.mercury_core"));
    ...
    public void method_7888(class_1799 stack, class_1937 world, class_1297 entity, int slot, boolean selected) {
        if (!world.method_8608()) {
            ...
            if (this.tick == 30) {
                ...
                world.method_8501(new class_2338(this.x, this.y + 1, this.z), class_2246.field_10199.method_9564());
            }
            if (this.tick == 40) {
                ((class_3218)world).method_14199((class_2394)class_2398.field_11207, (double)this.x + 0.5, (double)(this.y + 1), (double)this.z + 0.5, 5, 0.0, 0.0, 0.0, 1.0);
                for (i = -1; i <= 1; i += 2) {
                ...
                for (i = -1; i <= 1; i += 2) {
                    world.method_8501(new class_2338(this.x + i, this.y + 1, this.z), class_2246.field_37572.method_9564());
                    world.method_8501(new class_2338(this.x, this.y + 1, this.z + i), class_2246.field_37572.method_9564());
                }
            }
            if (this.tick == 50) {
                for (i = -2; i <= 2; ++i) {
            ...
            if (entity instanceof class_1657 && (player = (class_1657)entity).method_23318() >= 202.0 && player.method_6059(class_1294.field_5902)) {
                ...
                for (double i2 = -50.0; i2 <= 100.0; i2 += 1.0) {
                    for (double j2 = -50.0; j2 <= 100.0; j2 += 1.0) {
                        ...
                        world.method_8501(new class_2338(this.x + (int)i2, 200, this.z + (int)j2), class_2246.field_10087.method_9564());
                    }
                }
            }
            if (this.spawnTick == 60) {
                BossMercuryEntity customEntity = (BossMercuryEntity)((class_1299)class_1299.method_5898((String)"civilizations:boss_mercury").get()).method_5883(world);
                customEntity.method_30634((double)this.x + 0.5, 205.0, (double)this.z + 0.5);
                ...
                if (entity instanceof class_1657) {
                    ...
                    player3.method_31548().method_5447(slot, new class_1799((class_1935)ModItems.ROME_CORE));
                }
            }
            if (this.tick == 100) {
                for (double i3 = -50.0; i3 <= 100.0; i3 += 1.0) {
                    for (double j3 = -50.0; j3 <= 100.0; j3 += 1.0) {
                        ...
                        world.method_8501(new class_2338(this.x + (int)i3, 200, this.z + (int)j3), class_2246.field_10087.method_9564());
                    }
                }
            }
            if (this.tick == 130) {
                for (double i4 = -50.0; i4 <= 100.0; i4 += 1.0) {
                    for (double j4 = -50.0; j4 <= 100.0; j4 += 1.0) {
                        ...
                        world.method_8501(new class_2338(this.x + (int)i4, 200, this.z + (int)j4), class_2246.field_10087.method_9564());
                    }
                }
            }
            if (this.tick == 160) {
                for (double i5 = -50.0; i5 <= 100.0; i5 += 1.0) {
                    for (double j5 = -50.0; j5 <= 100.0; j5 += 1.0) {
                        ...
                        world.method_8501(new class_2338(this.x + (int)i5, 200, this.z + (int)j5), class_2246.field_10087.method_9564());
                    }
                }
            }
            if (this.tick == 190) {
                for (double i6 = -50.0; i6 <= 100.0; i6 += 1.0) {
                    for (double j6 = -50.0; j6 <= 100.0; j6 += 1.0) {
                        ...
                        world.method_8501(new class_2338(this.x + (int)i6, 200, this.z + (int)j6), class_2246.field_10087.method_9564());
                    }
                }
            }
            if (this.tick == 210) {
                for (double i7 = -50.0; i7 <= 100.0; i7 += 1.0) {
                    for (double j7 = -50.0; j7 <= 100.0; j7 += 1.0) {
                        ...
                        world.method_8501(new class_2338(this.x + (int)i7, 200, this.z + (int)j7), class_2246.field_10087.method_9564());
                    }
                }
            }
            if (this.tick == 240) {
                for (double i8 = -50.0; i8 <= 100.0; i8 += 1.0) {
                    for (double j8 = -50.0; j8 <= 100.0; j8 += 1.0) {
                        ...
                        world.method_8501(new class_2338(this.x + (int)i8, 200, this.z + (int)j8), class_2246.field_10087.method_9564());
                    }
                }
            }
            if (this.tick == 270) {
                for (double i9 = -50.0; i9 <= 100.0; i9 += 1.0) {
                    for (double j9 = -50.0; j9 <= 100.0; j9 += 1.0) {
                        ...
                        world.method_8501(new class_2338(this.x + (int)i9, 200, this.z + (int)j9), class_2246.field_10087.method_9564());
                    }
                }
            }
            if (this.tick == 300) {
                for (double i10 = -50.0; i10 <= 100.0; i10 += 1.0) {
                    for (double j10 = -50.0; j10 <= 100.0; j10 += 1.0) {
                        ...
                        world.method_8501(new class_2338(this.x + (int)i10, 200, this.z + (int)j10), class_2246.field_10087.method_9564());
                    }
                }
            }
        } else {
