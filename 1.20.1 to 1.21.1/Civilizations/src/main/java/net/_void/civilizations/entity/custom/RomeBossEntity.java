...
public class RomeBossEntity
extends class_1429 {
    private static final class_2940<Boolean> ATTACKING = class_2945.method_12791(RomeBossEntity.class, (class_2941)class_2943.field_13323);
    ...
    int guardsSpawned = 0;
    int spawnTick = 0;
    private final class_3213 bossBar = new class_3213((class_2561)class_2561.method_43471((String)"entity.civilizations.rome_boss"), class_1259.class_1260.field_5784, class_1259.class_1261.field_5790);

    public RomeBossEntity(class_1299<? extends class_1429> entityType, class_1937 world) {
    ...
    public void method_5773() {
        ...
        for (class_1657 player : this.method_37908().method_18456()) {
            ...
            if (player.method_5858((class_1297)this) <= 2500.0) {
                ...
                buffer.method_10814("RomeBossPlay");
            ...
            buffer = PacketByteBufs.create();
            buffer.method_10814("RomeBossStop");
            ServerPlayNetworking.send((class_3222)((class_3222)player), (class_2960)ModMessages.BOSS_MUSIC_PLAY, (class_2540)buffer);
        }
    }
    ...
    protected void method_5959() {
        ...
        this.field_6201.method_6277(1, (class_1352)new RomeBossAttackGoal((class_1314)this, 1.0, true));
        this.field_6201.method_6277(2, (class_1352)new class_1379((class_1314)this, 1.0));
        this.field_6185.method_6277(1, (class_1352)new class_1400((class_1308)this, RomeGuardEntity.class, false));
    ...
    public static class_5132.class_5133 createBossAttributes() {
        return class_1308.method_26828().method_26868(class_5134.field_23716, 800.0).method_26868(class_5134.field_23724, 5.0).method_26868(class_5134.field_23721, 9.0).method_26868(class_5134.field_23719, (double)0.3f).method_26868(class_5134.field_23717, 15.0).method_26868(class_5134.field_23718, 0.5);
    }
    ...
    protected void method_5958() {
        ...
        ++this.spawnTick;
        if (this.guardsSpawned == 0) {
            for (double i = this.method_23317() - 3.0; i <= this.method_23317() + 3.0; i += 3.0) {
                for (double j = this.method_23321() - 3.0; j <= this.method_23321() + 3.0; j += 3.0) {
                    RomeGuardEntity customEntity = (RomeGuardEntity)((class_1299)class_1299.method_5898((String)"civilizations:rome_guard").get()).method_5883(this.method_37908());
                    customEntity.method_30634(i, this.method_23318() - 18.0, j);
                    this.method_37908().method_8649((class_1297)customEntity);
                }
            }
            this.guardsSpawned += 9;
        } else if (this.spawnTick % 240 == 0 && this.guardsSpawned - this.guardsKilled <= 4) {
            for (int i = 0; i <= 1; ++i) {
                for (int j = 0; j <= 1; ++j) {
                    RomeGuardEntity customEntity = (RomeGuardEntity)((class_1299)class_1299.method_5898((String)"civilizations:rome_guard").get()).method_5883(this.method_37908());
                    customEntity.method_30634(this.method_23317() - 2.0 + (double)(4 * i), this.method_23318(), this.method_23321() - 2.0 + (double)(4 * j));
                    this.method_37908().method_8649((class_1297)customEntity);
                }
            }
            this.guardsSpawned += 4;
        }
    ...
    public boolean method_5643(class_1282 source, float amount) {
        if (source.method_49708(class_8111.field_42335) || source.method_49708(class_8111.field_42337) || source.method_49708(class_8111.field_42338) || source.method_49708(class_8111.field_42345) || source.method_49708(class_8111.field_42342) || source.method_49708(class_8111.field_42340) || source.method_49708(class_8111.field_42321)) {
            return false;
        }
    ...
    protected void method_6099(class_1282 source, int lootingMultiplier, boolean allowDrops) {
        ...
        class_1542 itemEntity = this.method_5706((class_1935)ModItems.ROME_SWORD);
        if (itemEntity != null) {
            itemEntity.method_6976();
            itemEntity.method_5684(true);
        }
        if ((itemEntity2 = this.method_5706((class_1935)ModItems.ROME_CORE)) != null) {
