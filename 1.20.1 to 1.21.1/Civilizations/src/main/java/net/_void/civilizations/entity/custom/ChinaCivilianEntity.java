...
public class ChinaCivilianEntity
extends class_1429 {
    private static final class_2940<Boolean> ATTACKING = class_2945.method_12791(ChinaCivilianEntity.class, (class_2941)class_2943.field_13323);
    ...
    Map<class_1792, Integer> outputItems = new HashMap<class_1792, Integer>(){
        {
            this.put(class_1802.field_8283, 1);
            this.put(class_1802.field_8873, 1);
            this.put(class_1802.field_8218, 1);
            this.put(class_1802.field_8313, 1);
            this.put(class_1802.field_8578, 1);
            this.put(class_1802.field_8175, 1);
            this.put(class_1802.field_8448, 1);
            this.put(class_1802.field_8895, 1);
            this.put(class_1802.field_27022, 3);
            this.put(class_1802.field_8621, 8);
            this.put(class_1802.field_8407, 6);
            this.put(class_1802.field_8794, 5);
            this.put(class_1802.field_8276, 4);
            this.put(class_1802.field_8745, 2);
            this.put(class_1802.field_8107, 5);
            this.put(class_1802.field_8880, 4);
            this.put(class_1802.field_17502, 4);
            this.put(class_1802.field_17510, 4);
            this.put(class_1802.field_17514, 4);
            this.put(class_1802.field_8648, 6);
            this.put(class_1802.field_37515, 4);
            this.put(class_1802.field_20386, 5);
            this.put(class_1802.field_23837, 4);
            this.put(class_1802.field_41956, 1);
            this.put(class_1802.field_8772, 1);
            this.put(class_1802.field_16313, 1);
            this.put(class_1802.field_16308, 1);
            this.put(class_1802.field_8643, 2);
            this.put(class_1802.field_8565, 1);
            this.put(ModItems.HIGH_MOUNTAINS_AND_FLOWING_WATER_MUSIC_DISC, 1);
            this.put(ModItems.AUTUMN_MOON_OVER_HAN_PALACE_MUSIC_DISC, 1);
        }
    };
    private static final class_2940<Integer> DATA_ID_TYPE_VARIANT = class_2945.method_12791(ChinaCivilianEntity.class, (class_2941)class_2943.field_13327);

    public ChinaCivilianEntity(class_1299<? extends class_1429> entityType, class_1937 world) {
    ...
    protected void method_5959() {
        ...
        this.field_6201.method_6277(1, (class_1352)new ChinaCivilianAttackGoal((class_1314)this, 1.0, true));
    ...
    public class_1296 method_5613(class_3218 world, class_1296 entity) {
        ChinaCivilianEntity baby = (ChinaCivilianEntity)ModEntities.CHINA_CIVILIAN.method_5883((class_1937)world);
        ChinaCivilianVariant variant = (ChinaCivilianVariant)((Object)class_156.method_27173((Object[])ChinaCivilianVariant.values(), (class_5819)this.field_5974));
    ...
    public ChinaCivilianVariant getVariant() {
        return ChinaCivilianVariant.byId(this.getTypeVariant() & 0xFF);
    }
    ...
    protected void method_5958() {
        if (this.trading >= 1) {
            ...
            if (this.tradingDuration == 100) {
                ((class_3218)this.method_37908()).method_14199((class_2394)class_2398.field_11211, this.method_23317(), this.method_23320(), this.method_23321(), 10, 0.2, 0.2, 0.2, 1.0);
                if (this.trading == 2) {
                    this.method_5775(new class_1799((class_1935)ModItems.CHINA_COIN, 2));
                } else if (this.trading == 3) {
                    this.method_5775(new class_1799((class_1935)ModItems.CHINA_COIN, 10));
                } else {
    ...
    public class_1269 method_5992(class_1657 player, class_1268 hand) {
        ...
        class_1792 item;
        if (!this.method_37908().method_8608() && ((item = (itemStack = player.method_6047()).method_7909()).equals(class_1802.field_8620) || item.equals(ModItems.CHINA_COIN) || item.equals(ModItems.CHINA_KEY)) && this.trading == 0) {
            this.trader = player;
            this.trading = 1;
            if (item.equals(class_1802.field_8620)) {
                this.trading = 2;
            }
            if (item.equals(ModItems.CHINA_KEY)) {
                this.trading = 3;
            }
