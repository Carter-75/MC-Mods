...
public class NordicBossEntity
extends class_1429 {
    private static final class_2940<Boolean> ATTACKING = class_2945.method_12791(NordicBossEntity.class, (class_2941)class_2943.field_13323);
    public final class_7094 idleAnimationState = new class_7094();
    private int idleAnimationTimeout = 0;
    public final class_7094 attackAnimationState = new class_7094();
    public int attackAnimationTimeout = 0;
    private final class_3213 bossBar = new class_3213((class_2561)class_2561.method_43471((String)"entity.civilizations.nordic_boss"), class_1259.class_1260.field_5780, class_1259.class_1261.field_5790);

    public NordicBossEntity(class_1299<? extends class_1429> entityType, class_1937 world) {
    ...
    public void method_5773() {
        ...
        for (class_1657 player : this.method_37908().method_18456()) {
            ...
            if (player.method_5858((class_1297)this) <= 2500.0) {
                ...
                buffer.method_10814("NordicBossPlay");
            ...
            buffer = PacketByteBufs.create();
            buffer.method_10814("NordicBossStop");
            ServerPlayNetworking.send((class_3222)((class_3222)player), (class_2960)ModMessages.BOSS_MUSIC_PLAY, (class_2540)buffer);
        }
    }
    ...
    protected void method_5959() {
        ...
        this.field_6201.method_6277(1, (class_1352)new NordicBossAttackGoal((class_1314)this, 1.0, true));
    ...
    public static class_5132.class_5133 createBossAttributes() {
        return class_1308.method_26828().method_26868(class_5134.field_23716, 600.0).method_26868(class_5134.field_23724, 5.0).method_26868(class_5134.field_23721, 15.0).method_26868(class_5134.field_23719, (double)0.3f).method_26868(class_5134.field_23717, 75.0).method_26868(class_5134.field_23718, 0.5);
    }
    ...
    protected void method_6099(class_1282 source, int lootingMultiplier, boolean allowDrops) {
        ...
        class_1542 itemEntity = this.method_5706((class_1935)ModItems.NORDIC_BATTLE_AXE);
        if (itemEntity != null) {
            itemEntity.method_6976();
            itemEntity.method_5684(true);
        }
        if ((itemEntity2 = this.method_5706((class_1935)ModItems.NORDIC_CORE)) != null) {
