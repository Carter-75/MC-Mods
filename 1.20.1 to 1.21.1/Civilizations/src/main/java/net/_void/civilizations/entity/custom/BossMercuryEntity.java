...
public class BossMercuryEntity
extends class_1429 {
    private static final class_2940<Boolean> ATTACK = class_2945.method_12791(BossMercuryEntity.class, (class_2941)class_2943.field_13323);
    public final class_7094 idleAnimationState = new class_7094();
    private int idleAnimationTimeout = 0;
    public final class_7094 attackAnimationState = new class_7094();
    public int attackAnimationTimeout = 0;
    private int timer = 0;
    private static class_2940<Integer> X = class_2945.method_12791(BossMercuryEntity.class, (class_2941)class_2943.field_13327);
    private static class_2940<Integer> Y = class_2945.method_12791(BossMercuryEntity.class, (class_2941)class_2943.field_13327);
    private static class_2940<Integer> Z = class_2945.method_12791(BossMercuryEntity.class, (class_2941)class_2943.field_13327);
    private final class_3213 bossBar = new class_3213((class_2561)class_2561.method_43471((String)"entity.civilizations.boss_mercury"), class_1259.class_1260.field_5782, class_1259.class_1261.field_5790);
    ...
    public BossMercuryEntity(class_1299<? extends class_1429> entityType, class_1937 world) {
    ...
    public void method_5773() {
        ...
        for (class_1657 player : this.method_37908().method_18456()) {
            ...
            if (player.method_5858((class_1297)this) <= 2500.0) {
                ...
                buffer.method_10814("RomeGodPlay");
            ...
            buffer = PacketByteBufs.create();
            buffer.method_10814("RomeGodStop");
            ServerPlayNetworking.send((class_3222)((class_3222)player), (class_2960)ModMessages.BOSS_MUSIC_PLAY, (class_2540)buffer);
        }
    }
    ...
    protected void method_5959() {
        ...
        this.field_6201.method_6277(1, (class_1352)new BossMercuryAttackGoal((class_1314)this));
    ...
    public static class_5132.class_5133 createBossAttributes() {
        return class_1308.method_26828().method_26868(class_5134.field_23716, 1200.0).method_26868(class_5134.field_23724, 5.0).method_26868(class_5134.field_23721, 12.0).method_26868(class_5134.field_23719, (double)0.2f).method_26868(class_5134.field_23717, 75.0).method_26868(class_5134.field_23718, 2.0);
    }
    ...
    protected void method_5958() {
        ...
        ++this.timer;
        this.method_6092(new class_1293(class_1294.field_5906, 300, 100, false, false));
        if (this.timer % 50 == 1) {
            this.method_6092(new class_1293(class_1294.field_5902, 37, 0, false, false));
        }
        if (this.timer == 300) {
            this.timer = 0;
            class_1634 customEntity = (class_1634)((class_1299)class_1299.method_5898((String)"minecraft:vex").get()).method_5883(this.method_37908());
            customEntity.method_30634(this.method_23317() + 1.0, this.method_23318(), this.method_23321());
            this.method_37908().method_8649((class_1297)customEntity);
            customEntity.method_6092(new class_1293(class_1294.field_5910, 1200, 2, false, false));
            class_1634 customEntity2 = (class_1634)((class_1299)class_1299.method_5898((String)"minecraft:vex").get()).method_5883(this.method_37908());
            customEntity2.method_30634(this.method_23317() - 1.0, this.method_23318(), this.method_23321());
            this.method_37908().method_8649((class_1297)customEntity2);
            customEntity2.method_6092(new class_1293(class_1294.field_5910, 1200, 2, false, false));
        }
    }
    ...
    public boolean method_5643(class_1282 source, float amount) {
        if (source.method_49708(class_8111.field_42335) || source.method_49708(class_8111.field_42337) || source.method_49708(class_8111.field_42338) || source.method_49708(class_8111.field_42345) || source.method_49708(class_8111.field_42342) || source.method_49708(class_8111.field_42340) || source.method_49708(class_8111.field_42323) || source.method_5529() instanceof class_1634) {
            return false;
        }
    ...
    public void method_6078(class_1282 damageSource) {
        ...
        class_1542 itemEntity = new class_1542(this.method_37908(), (double)((Integer)this.field_6011.method_12789(X)).intValue() + 0.5, (double)((Integer)this.field_6011.method_12789(Y)).intValue(), (double)((Integer)this.field_6011.method_12789(Z)).intValue() + 0.5, new class_1799((class_1935)ModItems.MERCURY_BOOTS));
