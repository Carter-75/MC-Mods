...
public class RomeCivilianAttackGoal
extends class_1366 {
    ...
    public RomeCivilianAttackGoal(class_1314 mob, double speed, boolean pauseWhenMobIdle) {
        super(mob, speed, pauseWhenMobIdle);
        this.entity = (RomeCivilianEntity)mob;
    }
