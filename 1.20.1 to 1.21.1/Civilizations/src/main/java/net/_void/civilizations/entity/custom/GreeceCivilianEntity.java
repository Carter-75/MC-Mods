...
public class GreeceCivilianEntity
extends class_1429 {
    private static final class_2940<Boolean> ATTACKING = class_2945.method_12791(GreeceCivilianEntity.class, (class_2941)class_2943.field_13323);
    ...
    Map<class_1792, Integer> farmItems = new HashMap<class_1792, Integer>(){
        {
            this.put(class_1802.field_17531, 7);
            this.put(class_1802.field_8861, 9);
            this.put(class_1802.field_8188, 5);
            this.put(class_1802.field_8706, 4);
        }
    };
    Map<class_1792, Integer> flowerItems = new HashMap<class_1792, Integer>(){
        {
            this.put(class_1802.field_17514, 6);
            this.put(class_1802.field_17510, 5);
            this.put(class_1802.field_17512, 7);
            this.put(class_1802.field_17501, 4);
        }
    };
    Map<class_1792, Integer> combatItems = new HashMap<class_1792, Integer>(){
        {
            this.put(class_1802.field_8371, 1);
            this.put(class_1802.field_8475, 1);
            this.put(class_1802.field_8255, 1);
        }
    };
    Map<class_1792, Integer> foodItems = new HashMap<class_1792, Integer>(){
        {
            this.put(class_1802.field_8279, 4);
            this.put(class_1802.field_8208, 1);
            this.put(class_1802.field_20417, 6);
            this.put(class_1802.field_8179, 5);
        }
    };
    Map<class_1792, Integer> bookItems = new HashMap<class_1792, Integer>(){
        {
            this.put(class_1802.field_8529, 5);
            this.put(class_1802.field_8536, 2);
            this.put(class_1802.field_16313, 1);
            this.put(class_1802.field_16312, 1);
        }
    };
    private static final class_2940<Integer> DATA_ID_TYPE_VARIANT = class_2945.method_12791(GreeceCivilianEntity.class, (class_2941)class_2943.field_13327);

    public GreeceCivilianEntity(class_1299<? extends class_1429> entityType, class_1937 world) {
    ...
    protected void method_5959() {
        ...
        this.field_6201.method_6277(1, (class_1352)new GreeceCivilianAttackGoal((class_1314)this, 1.0, true));
    ...
    public class_1296 method_5613(class_3218 world, class_1296 entity) {
        GreeceCivilianEntity baby = (GreeceCivilianEntity)ModEntities.GREECE_CIVILIAN.method_5883((class_1937)world);
        GreeceCivilianVariant variant = (GreeceCivilianVariant)((Object)class_156.method_27173((Object[])GreeceCivilianVariant.values(), (class_5819)this.field_5974));
    ...
    public GreeceCivilianVariant getVariant() {
        return GreeceCivilianVariant.byId(this.getTypeVariant() & 0xFF);
    }
    ...
    protected void method_5958() {
        if (this.trading >= 1) {
            ...
            if (this.tradingDuration == 100) {
                ((class_3218)this.method_37908()).method_14199((class_2394)class_2398.field_11211, this.method_23317(), this.method_23320(), this.method_23321(), 10, 0.2, 0.2, 0.2, 1.0);
                if (this.trading == 2) {
                    this.method_5775(new class_1799((class_1935)ModItems.GREECE_COIN, 5));
                } else {
                    ...
                    switch (this.getTypeVariant()) {
                        ...
                        case 4: {
                            map = this.flowerItems;
                            break;
                        }
                        case 6: 
                        case 8: {
                            map = this.combatItems;
                        }
                    }
                    Object[] values = map.keySet().toArray();
                    class_1792 randomItem = (class_1792)values[generator.nextInt(values.length)];
                    this.method_5775(new class_1799((class_1935)randomItem, ((Integer)map.get(randomItem)).intValue()));
                }
    ...
    public class_1269 method_5992(class_1657 player, class_1268 hand) {
        ...
        class_1792 item;
        if (!this.method_37908().method_8608() && ((item = (itemStack = player.method_6047()).method_7909()).equals(class_1802.field_8695) || item.equals(ModItems.GREECE_COIN)) && this.trading == 0) {
            this.trader = player;
            this.trading = 1;
            if (item.equals(class_1802.field_8695)) {
                this.trading = 2;
            }
