...
public class GreeceKey
extends class_1792 {
    public GreeceKey(class_1792.class_1793 settings) {
        super(settings);
    }
    ...
    public class_1269 method_7884(class_1838 context) {
        ...
        if (!context.method_8045().method_8608()) {
            ...
            if (state.method_26204().equals(ModBlocks.GREECE_CHEST)) {
                context.method_8045().method_8501(positionClicked, class_2246.field_10124.method_9564());
                GreeceBossEntity customEntity = (GreeceBossEntity)((class_1299)class_1299.method_5898((String)"civilizations:greece_boss").get()).method_5883(context.method_8045());
