...
public class RomeGuardModel<T extends RomeGuardEntity>
extends class_5597<T> {
    private final class_630 body;
    private final class_630 head;

    public RomeGuardModel(class_630 root) {
    ...
    public static class_5607 getTexturedModelData() {
        ...
        class_5610 sword = rightarm.method_32117("sword", class_5606.method_32108().method_32101(48, 44).method_32098(-0.5f, -7.125f, -7.1875f, 1.0f, 1.0f, 3.0f, new class_5605(0.0f)).method_32101(44, 53).method_32098(-0.5f, -6.125f, -7.1875f, 1.0f, 1.0f, 4.0f, new class_5605(0.0f)).method_32101(48, 38).method_32098(-0.5f, -5.125f, -7.1875f, 1.0f, 1.0f, 5.0f, new class_5605(0.0f)).method_32101(48, 32).method_32098(-0.5f, -4.125f, -6.1875f, 1.0f, 1.0f, 5.0f, new class_5605(0.0f)).method_32101(32, 48).method_32098(-0.5f, -3.125f, -5.1875f, 1.0f, 1.0f, 5.0f, new class_5605(0.0f)).method_32101(54, 53).method_32098(-0.5f, -2.125f, -4.1875f, 1.0f, 1.0f, 4.0f, new class_5605(0.0f)).method_32101(44, 48).method_32098(-0.5f, -1.125f, -3.1875f, 1.0f, 1.0f, 4.0f, new class_5605(0.0f)).method_32101(32, 54).method_32098(-0.5f, -0.125f, -1.1875f, 1.0f, 1.0f, 3.0f, new class_5605(0.0f)).method_32101(54, 48).method_32098(-0.5f, 0.875f, -0.1875f, 1.0f, 1.0f, 2.0f, new class_5605(0.0f)), class_5603.method_32091((float)-0.5f, (float)8.125f, (float)0.1875f, (float)0.7854f, (float)0.0f, (float)0.0f));
