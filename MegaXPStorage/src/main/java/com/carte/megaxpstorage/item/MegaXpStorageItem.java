...
public class MegaXpStorageItem extends Item {
	...
	private static final ThreadLocal<Boolean> ADDING_LEVELS = ThreadLocal.withInitial(() -> false);
	...
	private static void addLevels(PlayerEntity player, long levels) {
		...
		try {
			...
			ADDING_LEVELS.set(false);
		}
	}

	public static boolean isAddingLevels() {
		return ADDING_LEVELS.get();
	}
}
