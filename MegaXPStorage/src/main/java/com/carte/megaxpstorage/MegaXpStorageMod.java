...
public class MegaXpStorageMod implements ModInitializer {
	...
	public static final Item SUPER_BOOK = Registry.register(
			Registries.ITEM,
			id("super_book"),
			new Item(new Item.Settings())
	);

	public static final Item MEGA_BOOK = Registry.register(
			Registries.ITEM,
			id("mega_book"),
			new Item(new Item.Settings())
	);

	public static final Item SUPER_LAPIS = Registry.register(
			Registries.ITEM,
			id("super_lapis"),
			new Item(new Item.Settings())
	);

	public static final Item MEGA_LAPIS = Registry.register(
			Registries.ITEM,
			id("mega_lapis"),
			new Item(new Item.Settings())
	);
	...
	public static final Item MEGA_XP_STORAGE_MENDING = Registry.register(
			Registries.ITEM,
			id("mega_xp_storage_mending"),
			new MegaXpStorageItem(new Item.Settings().maxCount(1))
	);
	...
	public void onInitialize() {
		...
		ItemGroupEvents.modifyEntriesEvent(ItemGroups.TOOLS).register(entries -> {
			entries.add(SUPER_BOOK);
			entries.add(MEGA_BOOK);
			entries.add(SUPER_LAPIS);
			entries.add(MEGA_LAPIS);
			entries.add(MEGA_XP_STORAGE);
			entries.add(MEGA_XP_STORAGE_MENDING);
		});
