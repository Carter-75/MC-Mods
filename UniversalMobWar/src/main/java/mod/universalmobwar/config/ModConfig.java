...
public class ModConfig implements ConfigData {
    ...
    // DEFAULT BEHAVIOR (26.2): true free-for-all. Every mob attacks every mob AND the player,
    // but friends/allies are spared. Targeting + targetPlayers + ignoreSameSpecies are the only
    // things ON by default; every other system defaults OFF.
    ...
    @ConfigEntry.Gui.Tooltip(count = 2)
    public boolean ignoreSameSpecies = true; // friends/same-species spared
    ...
    public boolean limitNaturalMobSpawns = false; // extra feature OFF by default
    ...
    @ConfigEntry.Gui.Tooltip(count = 2)
    public boolean allianceEnabled = false; // extra system OFF by default
    ...
    @ConfigEntry.Gui.Tooltip(count = 2)
    public boolean scalingEnabled = false; // extra system OFF by default
    ...
    public boolean allowModdedEnchantments = false; // extra feature OFF by default
    ...
    @ConfigEntry.Gui.Tooltip(count = 2)
    public boolean warlordEnabled = false; // extra system OFF by default
    ...
    @ConfigEntry.Gui.Excluded
    public transient boolean evolutionSystemEnabled = false; // Maps to scalingEnabled
    
    @ConfigEntry.Gui.Excluded  
    public transient boolean allianceSystemEnabled = false; // Maps to allianceEnabled
    
    @ConfigEntry.Gui.Excluded
    public transient boolean enableMobWarlord = false; // Maps to warlordEnabled
