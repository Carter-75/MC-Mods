...
public class UniversalMobWarModClient implements ClientModInitializer {
    ...
    public void onInitializeClient() {
        ...
        // MC 26.2: WorldRenderEvents.LAST was removed; the closest equivalent for
        // custom world-space geometry is LevelRenderEvents.AFTER_TRANSLUCENT_TERRAIN.
        LevelRenderEvents.AFTER_TRANSLUCENT_TERRAIN.register(new MobVisualRenderer());
